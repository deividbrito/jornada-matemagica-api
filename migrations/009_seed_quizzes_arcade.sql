...
INSERT INTO alternativa (id_quiz, texto, eh_correta, file) VALUES
  (1798, '355 milhões.', 1, NULL),
  (1798, '400 milhões.', 0, NULL),
  (1798, '426 milhões.', 0, NULL),
  (1798, '441 milhões.', 0, NULL),
  (1798, '477 milhões.', 0, NULL),
  (1799, '25 min.', 0, NULL),
  (1799, '15 min.', 0, NULL),
  (1799, '2,5 min.', 0, NULL),
  (1799, '1,5 min.', 1, NULL),
  (1799, '0,15 min.', 0, NULL),
  (1800, '490 e 510 milhões.', 0, NULL),
  (1800, '550 e 620 milhões.', 0, NULL),
  (1800, '780 e 800 milhões.', 0, NULL),
  (1800, '810 e 860 milhões.', 0, NULL),
  (1800, '870 e 910 milhões.', 1, NULL),
  (1801, '1/2.', 0, NULL),
  (1801, '7/20.', 0, NULL),
  (1801, '8/25.', 1, NULL),
  (1801, '1/5.', 0, NULL),
  (1801, '3/25.', 0, NULL),
  (1802, '27,75 milhões de litros.', 0, NULL),
  (1802, '37,00 milhões de litros.', 0, NULL),
  (1802, '231,25 milhões de litros.', 0, NULL),
  (1802, '693,75 milhões de litros.', 1, NULL),
  (1802, '888,00 milhões de litros.', 0, NULL),
  (1803, 'O consumo diário de cigarros e o número de casos de câncer de pulmão são grandezas inversamente proporcionais.', 0, NULL),
  (1803, 'O consumo diário de cigarros e o número de casos de câncer de pulmão são grandezas que não se relacionam.', 0, NULL),
  (1803, 'O consumo diário de cigarros e o número de casos de câncer de pulmão são grandezas diretamente proporcionais.', 0, NULL),
  (1803, 'Uma pessoa não fumante certamente nunca será diagnosticada com câncer de pulmão.', 0, NULL),
  (1803, 'O consumo diário de cigarros e o número de casos de câncer de pulmão são grandezas que estão relacionadas, mas sem proporcionalidade.', 1, NULL),
  (1804, '23.940.', 0, NULL),
  (1804, '32.228.', 0, NULL),
  (1804, '920.800.', 0, NULL),
  (1804, '23.940.800.', 1, NULL),
  (1804, '32.228.000.', 0, NULL),
  (1805, '24 fusas.', 0, NULL),
  (1805, '3 semínimas.', 0, NULL),
  (1805, '8 semínimas.', 0, NULL),
  (1805, '24 colcheias e 12 semínimas.', 1, NULL),
  (1805, '16 semínimas e 8 semicolcheias.', 0, NULL),
  (1806, '2 × (0,2%)4.', 0, NULL),
  (1806, '4 × (0,2%)2.', 0, NULL),
  (1806, '6 × (0,2%)2  × (99,8%)2.', 1, NULL),
  (1806, '4 × (0,2%).', 0, NULL),
  (1806, '6 × (0,2%) × (99,8%).', 0, NULL),
  (1807, 'R$ 90,00.', 1, NULL),
  (1807, 'R$ 110,00.', 0, NULL),
  (1807, 'R$ 130,00.', 0, NULL),
  (1807, 'R$ 150,00.', 0, NULL),
  (1807, 'R$ 170,00.', 0, NULL),
  (1808, '1 após girá-la 90° no sentido horário.', 0, NULL),
  (1808, '1 após girá-la 180° no sentido anti-horário.', 0, NULL),
  (1808, '2 após girá-la 90° no sentido anti-horário.', 1, NULL),
  (1808, '2 após girá-la 180° no sentido horário.', 0, NULL),
  (1808, '2 após girá-la 270° no sentido anti-horário.', 0, NULL),
  (1809, 'Inferior a 0,18.', 0, NULL),
  (1809, 'Superior a 0,18 e inferior a 0,50.', 0, NULL),
  (1809, 'Superior a 0,50 e inferior a 1,50.', 0, NULL),
  (1809, 'Superior a 1,50 e inferior a 2,80.', 1, NULL),
  (1809, 'Superior a 2,80.', 0, NULL),
  (1811, 'Inferior a 300 milhões de dólares.', 0, NULL),
  (1811, 'Superior a 300 milhões de dólares, mas inferior a 400 milhões de dólares.', 0, NULL),
  (1811, 'Superior a 400 milhões de dólares, mas inferior a 500 milhões de dólares.', 0, NULL),
  (1811, 'Superior a 500 milhões de dólares, mas inferior a 600 milhões de dólares.', 1, NULL),
  (1811, 'Superior a 600 milhões de dólares.', 0, NULL),
  (1812, 'R$ 14,00.', 0, NULL),
  (1812, 'R$ 17,00.', 0, NULL),
  (1812, 'R$ 22,00.', 0, NULL),
  (1812, 'R$ 32,00.', 1, NULL),
  (1812, 'R$ 57,00.', 0, NULL),
  (1813, '1,5 x 102 vezes a capacidade do reservatório novo.', 0, NULL),
  (1813, '1,5 x 103 vezes a capacidade do reservatório novo.', 0, NULL),
  (1813, '1,5 x 106 vezes a capacidade do reservatório novo.', 0, NULL),
  (1813, '1,5 x 108 vezes a capacidade do reservatório novo.', 0, NULL),
  (1813, '1,5 x 109 vezes a capacidade do reservatório novo.', 1, NULL),
  (1814, 'Dois triângulos congruentes com lados correspondentes paralelos.', 1, NULL),
  (1814, 'Dois retângulos congruentes e com lados correspondentes paralelos.', 0, NULL),
  (1814, 'Dois trapézios congruentes com lados correspondentes perpendiculares.', 0, NULL),
  (1814, 'Dois paralelogramos congruentes com lados correspondentes paralelos.', 0, NULL),
  (1814, 'Dois quadriláteros congruentes com lados correspondentes perpendiculares.', 0, NULL),
  (1815, '1,16 metros.', 0, NULL),
  (1815, '3,0 metros.', 0, NULL),
  (1815, '5,4 metros.', 0, NULL),
  (1815, '5,6 metros.', 1, NULL),
  (1815, '7,04 metros.', 0, NULL),
  (1816, 'V = 10.000 + 50x – x².', 0, NULL),
  (1816, 'V = 10.000 + 50x + x².', 0, NULL),
  (1816, 'V = 15.000 – 50x – x².', 0, NULL),
  (1816, 'V = 15.000 + 50x – x².', 1, NULL),
  (1816, 'V = 15.000 – 50x + x².', 0, NULL),
  (1817, '0 e 9.', 1, NULL),
  (1817, '1 e 4.', 0, NULL),
  (1817, '1 e 7.', 0, NULL),
  (1817, '9 e 1.', 0, NULL),
  (1817, '0 e 1.', 0, NULL),
  (1818, '2,9 cm × 3,4 cm.', 0, NULL),
  (1818, '3,9 cm × 4,4 cm.', 0, NULL),
  (1818, '20 cm × 25 cm.', 0, NULL),
  (1818, '21 cm × 26 cm.', 1, NULL),
  (1818, '192 cm × 242 cm.', 0, NULL),
  (1819, 'Y = 30x.', 0, NULL),
  (1819, 'Y = 25x + 20,2.', 0, NULL),
  (1819, 'Y = 1,27x.', 0, NULL),
  (1819, 'Y = 0,7x.', 0, NULL),
  (1819, 'Y = 0,07x + 6.', 1, NULL),
  (1820, 'Manter sua proposta.', 0, NULL),
  (1820, 'Oferecer 4 máquinas a mais.', 0, NULL),
  (1820, 'Oferecer 6 trabalhadores a mais.', 0, NULL),
  (1820, 'Aumentar a jornada de trabalho para 9 horas diárias.', 1, NULL),
  (1820, 'Reduzir em R$ 400,00 o valor do aluguel diário de uma máquina.', 0, NULL),
  (1821, 'Teria a pontuação igual a 6,5 se ele obtivesse nota 0.', 0, NULL),
  (1821, 'Seria a vencedora se ele obtivesse nota 10.', 0, NULL),
  (1821, 'Seria a segunda colocada se ele obtivesse nota 8.', 0, NULL),
  (1821, 'Permaneceria na terceira posição, independentemente da nota obtida pelo aluno.', 1, NULL),
  (1821, 'Empataria com a equipe Ômega na primeira colocação se o aluno obtivesse nota 9.', 0, NULL),
  (1822, '920 kg.', 1, NULL),
  (1822, '800 kg.', 0, NULL),
  (1822, '720 kg.', 0, NULL),
  (1822, '600 kg.', 0, NULL),
  ...
  (1824, '33%', 0, NULL),
  (1824, '19%', 1, NULL),
  (1825, 'Uma combinação e um arranjo, respectivamente.', 1, NULL),
  (1825, 'Um arranjo e uma combinação, respectivamente.', 0, NULL),
  (1825, 'Um arranjo e uma permutação, respectivamente.', 0, NULL),
  (1825, 'Duas combinações.', 0, NULL),
  (1825, 'Dois arranjos.', 0, NULL),
  (1826, '1.400', 0, NULL),
  (1826, '14.000', 0, NULL),
  (1826, '140.000', 0, NULL),
  (1826, '1.400.000', 0, NULL),
  (1826, '14.000.000', 1, NULL),
  (1827, 'R$ 73,10.', 0, NULL),
  (1827, 'R$ 81,50.', 0, NULL),
  (1827, 'R$ 82,00.', 0, NULL),
  (1827, 'R$ 83,00.', 1, NULL),
  ...
  (1828, '90 m³/s.', 0, NULL),
  (1828, '750 m³/s.', 0, NULL),
  (1828, '1.050 m³/s.', 0, NULL),
  (1828, '1.512 m³/s.', 1, NULL),
  (1828, '2.009 m³/s.', 0, NULL),
  (1829, 'Um CD de 700 MB.', 0, NULL),
  (1829, 'Um pendrive de 1 GB.', 0, NULL),
  (1829, 'Um HD externo de 16 GB.', 0, NULL),
  (1829, 'Um memory stick de 16 MB.', 0, NULL),
  (1829, 'Um cartão de memória de 64 MB.', 1, NULL),
  (1830, '1 1/2 vez menor.', 0, NULL),
  (1830, '2 1/2 vezes menor.', 0, NULL),
  (1830, '4 vezes menor.', 1, NULL),
  (1830, '9 vezes menor.', 0, NULL),
  (1830, '14 vezes menor.', 0, NULL),
  (1831, '600 milhões de dólares.', 0, NULL),
  (1831, '840 milhões de dólares.', 0, NULL),
  (1831, '1,34 bilhão de dólares.', 1, NULL),
  (1831, '1,44 bilhão de dólares.', 0, NULL),
  (1831, '2,00 bilhões de dólares.', 0, NULL),
  (1832, '156 cm³.', 0, NULL),
  (1832, '189 cm³.', 1, NULL),
  (1832, '192 cm³.', 0, NULL),
  (1832, '216 cm³.', 0, NULL),
  (1832, '540 cm³.', 0, NULL),
  (1833, 'R( 1 - sen d/r ).', 0, NULL),
  (1833, 'R( 1 - cos d/r ).', 1, NULL),
  (1833, 'R( 1 - tag d/r ).', 0, NULL),
  (1833, 'Rsen (r/d).', 0, NULL),
  (1833, 'Rcos (r/d).', 0, NULL),
  (1834, '10.000.', 0, NULL),
  (1834, '7.500.', 0, NULL),
  (1834, '5.000.', 1, NULL),
  (1834, '4.500.', 0, NULL),
  (1834, '3.000.', 0, NULL),
  (1835, 'Não poderia fazer sequer a metade dos exercícios e dispor dos períodos de descanso especificados em seu programa.', 0, NULL),
  (1835, 'Poderia ter feito todos os exercícios e cumprido rigorosamente os períodos de descanso especificados em seu programa.', 1, NULL),
  (1835, 'Poderia ter feito todos os exercícios, mas teria de ter deixado de cumprir um dos períodos de descanso especificados em seu programa.', 0, NULL),
  (1835, 'Conseguiria fazer todos os exercícios e cumpriria todos os períodos de descanso especificados em seu programa, e ainda se permitiria uma pausa de 7 min.', 0, NULL),
  (1835, 'Não poderia fazer todas as 3 séries dos exercícios especificados em seu programa; em alguma dessas séries deveria ter feito uma série a menos e não deveria ter cumprido um dos períodos de descanso.', 0, NULL),
  (1836, 'Uma pirâmide de base quadrada tem 4 arestas laterais e a interseção de um plano com a pirâmide intercepta suas arestas laterais. Assim, esses pontos formam um polígono de 4 lados.', 0, NULL),
  (1836, 'Uma pirâmide de base quadrada tem 4 faces triangulares e, quando um plano intercepta essa pirâmide, divide cada face em um triângulo e um trapézio. Logo, um dos polígonos tem 4 lados.', 0, NULL),
  (1836, 'Uma pirâmide de base quadrada tem 5 faces e a interseção de uma face com um plano é um segmento de reta. Assim, se o plano interceptar todas as faces, o polígono obtido nessa interseção tem 5 lados.', 1, NULL),
  (1836, 'O número de lados de qualquer polígono obtido como interseção de uma pirâmide com um plano é igual ao número de faces da pirâmide. Como a pirâmide tem 5 faces, o polígono tem 5 lados.', 0, NULL),
  (1836, 'O número de lados de qualquer polígono obtido interceptando-se uma pirâmide por um plano é igual ao número de arestas laterais da pirâmide. Como a pirâmide tem 4 arestas laterais, o polígono tem 4 lados.', 0, NULL),
  (1837, 'Renegociar suas dívidas com o banco.', 0, NULL),
  (1837, 'Pegar emprestado de José o dinheiro referente à quitação das duas dívidas.', 0, NULL),
  (1837, 'Recusar o empréstimo de José e pagar todas as parcelas pendentes nos devidos prazos.', 0, NULL),
  (1837, 'Pegar emprestado de José o dinheiro referente à quitação do cheque especial e pagar as parcelas do cartão de crédito.', 0, NULL),
  (1837, 'Pegar emprestado de José o dinheiro referente à quitação do cartão de crédito e pagar as parcelas do cheque especial.', 1, NULL),
  (1838, '6 metros por 5 metros, pois assim teria uma área de 30 m² .', 0, NULL),
  (1838, '15 metros por 20 metros, pois assim teria uma área de 300 m² .', 1, NULL),
  (1838, '50 metros por 60 metros, pois assim teria uma área de 3.000 m² .', 0, NULL),
  (1838, '91 metros por 30 metros, pois assim teria uma área de 2.730 m² .', 0, NULL),
  (1838, '110 metros por 30 metros, pois assim teria uma área de 3.300 m² .', 0, NULL),
  (1839, '3 doses.', 0, NULL),
  (1839, '4 doses.', 1, NULL),
  (1839, '6 doses.', 0, NULL),
  (1839, '8 doses.', 0, NULL),
  (1839, '10 doses.', 0, NULL),
  (1841, '1 : 20', 0, NULL),
  (1841, '1 : 100', 0, NULL),
  (1841, '1 : 200', 0, NULL),
  (1841, '1 : 1 000', 0, NULL),
  ...
  (1845, '8 344', 1, NULL),
  (1845, '9 536', 0, NULL),
  (1847, '100 km² e 900 km².', 0, NULL),
  (1847, '1 000 km² e 2 700 km².', 0, NULL),
  (1847, '2 800 km² e 3 200 km².', 1, NULL),
  (1847, '3 300 km² e 4 000 km².', 0, NULL),
  (1847, '4 100 km² e 5 800 km².', 0, NULL),
  (1848, 'Direta, direta e direta.', 0, NULL),
  (1848, 'Direta, direta e inversa.', 0, NULL),
  (1848, 'Direta, inversa e direta.', 1, NULL),
  (1848, 'Inversa, direta e direta.', 0, NULL),
  (1848, 'Inversa, direta e inversa.', 0, NULL),
  (1849, '24500', 1, NULL),
  (1849, '25000', 0, NULL),
  (1849, '220500', 0, NULL),
  (1849, '223000', 0, NULL),
  ...
  (1850, 'Massa.', 0, NULL),
  (1850, 'Volume.', 1, NULL),
  (1850, 'Superfície.', 0, NULL),
  (1850, 'Capacidade.', 0, NULL),
  (1850, 'Comprimento.', 0, NULL),
  (1851, 'E1E3.', 0, NULL),
  (1851, 'E1E4.', 0, NULL),
  (1851, 'E2E4.', 0, NULL),
  (1851, 'E2E5.', 1, NULL),
  (1851, 'E2E6', 0, NULL),
  (1852, 'U$ 4.174.000,00.', 0, NULL),
  (1852, 'U$ 41.740.000,00.', 0, NULL),
  (1852, 'U$ 417.400.000,00.', 0, NULL),
  (1852, 'U$ 41.740.000.000,00.', 0, NULL),
  (1852, 'U$ 417.400.000.000,00.', 1, NULL),
  (1853, 'C = 4Q', 0, NULL),
  (1853, 'C = 3Q + 1', 1, NULL),
  (1853, 'C = 4Q + 1', 0, NULL),
  (1853, 'C = Q + 3', 0, NULL),
  (1853, 'C = 4Q – 2', 0, NULL),
  (1854, 'O dobro do valor da primeira encomenda, porque a altura e a largura dos quadros dobraram.', 0, NULL),
  (1854, 'Maior do que o valor da primeira encomenda, mas não o dobro.', 1, NULL),
  (1854, 'A metade do valor da primeira encomenda, porque a altura e a largura dos quadros dobraram.', 0, NULL),
  (1854, 'Menor do que o valor da primeira encomenda, mas não a metade.', 0, NULL),
  (1854, 'Igual ao valor da primeira encomenda, porque o custo de entrega será o mesmo.', 0, NULL),
  (1855, 'Encher a leiteira até a metade, pois ela tem um volume 20 vezes maior que o volume do copo.', 1, NULL),
  (1855, 'Encher a leiteira toda de água, pois ela tem um volume 20 vezes maior que o volume do copo.', 0, NULL),
  (1855, 'Encher a leiteira toda de água, pois ela tem um volume 10 vezes maior que o volume do copo.', 0, NULL),
  (1855, 'Encher duas leiteiras de água, pois ela tem um volume 10 vezes maior que o volume do copo.', 0, NULL),
  (1855, 'Encher cinco leiteiras de água, pois ela tem um volume 10 vezes maior que o volume do copo.', 0, NULL),
  (1856, '12 765 km.', 0, NULL),
  (1856, '12 000 km', 1, NULL),
  (1856, '11 730 km', 0, NULL),
  (1856, '10 965 km.', 0, NULL),
  (1856, '5 865 km', 0, NULL),
  (1857, 'I, pela relação área/capacidade de armazenamento de 1/3', 0, NULL),
  (1857, 'I, pela relação área/capacidade de armazenamento de 4/3', 0, NULL),
  (1857, 'II, pela relação área/capacidade de armazenamento de 3/4', 0, NULL),
  (1857, 'III, pela relação área/capacidade de armazenamento de 2/3', 1, NULL),
  (1857, 'III, pela relação área/capacidade de armazenamento de 7/12', 0, NULL),
  (1858, 'Insuficiente.', 0, NULL),
  (1858, 'Regular.', 0, NULL),
  (1858, 'Bom.', 1, NULL),
  (1858, 'Ótimo.', 0, NULL),
  (1858, 'Excelente.', 0, NULL),
  (1859, '476', 0, NULL),
  (1859, '675', 0, NULL),
  (1859, '923', 1, NULL),
  (1859, '965', 0, NULL),
  (1859, '1538', 0, NULL),
  (1860, 'Menor ou igual a 200 m.', 1, NULL),
  (1860, 'Maior que 200 m e menor ou igual a 400 m.', 0, NULL),
  (1860, 'Maior que 400 m e menor ou igual a 600 m', 0, NULL),
  (1860, 'Maior que 600 m e menor ou igual a 800 m.', 0, NULL),
  (1860, 'Maior que 800 m.', 0, NULL),
  (1861, 'R$ 230,40.', 0, NULL),
  (1861, 'R$ 124,00.', 0, NULL),
  (1861, 'R$ 104,16.', 0, NULL),
  (1861, 'R$ 54,56.', 1, NULL),
  (1861, 'R$ 49,60.', 0, NULL),
  (1862, '29,9 toneladas.', 1, NULL),
  (1862, '31,1 toneladas.', 0, NULL),
  (1862, '32,4 toneladas.', 0, NULL),
  (1862, '35,3 toneladas.', 0, NULL),
  (1862, '41,8 toneladas.', 0, NULL),
  (1863, '0,4 cm/kg1/3.', 0, NULL),
  (1863, '2,5 cm/kg1/3.', 0, NULL),
  (1863, '8 cm/kg1/3.', 0, NULL),
  (1863, '20 cm/kg1/3.', 0, NULL),
  (1863, '40 cm/kg1/3.', 1, NULL),
  (1864, '1,8 km', 0, NULL),
  (1864, '1,9 km', 0, NULL),
  (1864, '3,1 km', 1, NULL),
  (1864, '3,7 km', 0, NULL),
  (1864, '5,5 km', 0, NULL),
  (1865, 'À mesma área do triângulo AMC.', 0, NULL),
  (1865, 'À mesma área do triângulo BNC.', 0, NULL),
  (1865, 'À metade da área formada pelo triângulo ABC.', 0, NULL),
  (1865, 'Ao dobro da área do triângulo MNC.', 0, NULL),
  (1865, 'Ao triplo da área do triângulo MNC.', 1, NULL),
  (1866, '1 mm.', 0, NULL),
  (1866, '10 mm.', 0, NULL),
  (1866, '17 mm.', 0, NULL),
  (1866, '160 mm.', 1, NULL),
  ...
  (1869, '130.', 1, NULL),
  (1869, '150.', 0, NULL),
  (1870, 'Menor que 1 150.', 0, NULL),
  (1870, '218 unidades maior que em 2004.', 0, NULL),
  (1870, 'Maior que 1 150 e menor que 1 200.', 1, NULL),
  (1870, '177 unidades maior que em 2010.', 0, NULL),
  (1870, 'Maior que 1 200.', 0, NULL),
  (1871, '6 gols', 0, NULL),
  (1871, '6,5 gols', 1, NULL),
  (1871, '7 gols', 0, NULL),
  (1871, '7,3 gols', 0, NULL),
  (1871, '8,5 gols', 0, NULL),
  (1872, '1,33', 0, NULL),
  (1872, '6,00', 1, NULL),
  (1872, '12,00', 0, NULL),
  (1872, '56,52', 0, NULL),
  (1872, '113,04', 0, NULL),
  (1873, '4,0 m e 5,0 m.', 0, NULL),
  (1873, '5,0 m e 6,0 m.', 0, NULL),
  (1873, '6,0 m e 7,0 m.', 0, NULL),
  (1873, '7,0 m e 8,0 m.', 1, NULL),
  (1873, '8,0 m e 9,0 m.', 0, NULL),
  (1874, 'Marco, pois a média e a mediana são iguais.', 0, NULL),
  (1874, 'Marco, pois obteve menor desvio padrão.', 1, NULL),
  (1874, 'Paulo, pois obteve a maior pontuação da tabela, 19 em Português.', 0, NULL),
  (1874, 'Paulo, pois obteve maior mediana.', 0, NULL),
  (1874, 'Paulo, pois obteve maior desvio padrão.', 0, NULL),
  (1875, '16%', 0, NULL),
  (1875, '24%', 1, NULL),
  (1875, '32%', 0, NULL),
  (1875, '48%', 0, NULL),
  ...
  (1883, '81', 1, NULL),
  (1883, '285', 0, NULL),
  (1884, '2004-2005', 0, NULL),
  (1884, '2005-2006', 0, NULL),
  (1884, '2006-2007', 0, NULL),
  (1884, '2007-2008', 0, NULL),
  (1884, '2008-2009', 1, NULL),
  (1885, '2004-2005', 0, NULL),
  (1885, '2005-2006', 0, NULL),
  (1885, '2006-2007', 0, NULL),
  (1885, '2007-2008', 0, NULL),
  (1885, '2008-2009', 1, NULL),
  (1886, '68,21 mm.', 0, NULL),
  (1886, '68,102 mm.', 0, NULL),
  (1886, '68,02 mm.', 0, NULL),
  (1886, '68,012 mm.', 0, NULL),
  (1886, '68,001 mm.', 1, NULL),
  (1887, '10-5,10', 0, NULL),
  (1887, '10-0,73', 0, NULL),
  (1887, '1012,00', 0, NULL),
  (1887, '1021,65', 0, NULL),
  (1887, '1027,00', 1, NULL),
  (1888, '0,23 e 0,16.', 0, NULL),
  (1888, '2,3 e 1,6.', 1, NULL),
  (1888, '23 e 16.', 0, NULL),
  (1888, '230 e 160.', 0, NULL),
  (1888, '2 300 e 1 600.', 0, NULL),
  (1889, '2 614.', 1, NULL),
  (1889, '2 624.', 0, NULL),
  (1889, '2 715.', 0, NULL),
  (1889, '2 725.', 0, NULL),
  ...
  (1890, '4.', 0, NULL),
  (1890, '5.', 0, NULL),
  (1891, '50 minutos.', 0, NULL),
  (1891, '60 minutos.', 1, NULL),
  (1891, '80 minutos.', 0, NULL),
  (1891, '120 minutos.', 0, NULL),
  (1891, '170 minutos.', 0, NULL),
  (1892, '17°C, 17°C e 13,5°C.', 0, NULL),
  (1892, '17°C, 18°C e 13,5°C.', 1, NULL),
  (1892, '17°C, 13,5°C e 18°C.', 0, NULL),
  (1892, '17°C, 18°C e 21,5°C.', 0, NULL),
  (1892, '17°C, 13,5°C e 21,5°C.', 0, NULL),
  (1893, '4,8 e 11,2', 0, NULL),
  (1893, '7,0 e 3,0', 0, NULL),
  (1893, '11,2 e 4,8', 1, NULL),
  (1893, '28,0 e 12,0', 0, NULL),
  (1893, '30,0 e 70,0', 0, NULL),
  (1894, 'Todos iguais.', 0, NULL),
  (1894, 'Todos diferentes.', 0, NULL),
  (1894, 'Três iguais e um diferente.', 0, NULL),
  (1894, 'Apenas dois iguais.', 0, NULL),
  (1894, 'Iguais dois a dois.', 1, NULL),
  (1895, '8 bilhões de litros.', 0, NULL),
  (1895, '16 bilhões de litros.', 0, NULL),
  (1895, '32 bilhões de litros.', 0, NULL),
  (1895, '40 bilhões de litros.', 0, NULL),
  (1895, '48 bilhões de litros.', 1, NULL),
  (1896, '1 : 250.', 0, NULL),
  (1896, '1 : 2 500.', 0, NULL),
  (1896, '1 : 25 000.', 0, NULL),
  (1896, '1 : 250 000.', 0, NULL),
  (1896, '1 : 25 000 000.', 1, NULL),
  (1897, '3 390 pés', 0, NULL),
  (1897, '9 390 pés', 0, NULL),
  (1897, '11 200 pés', 1, NULL),
  (1897, '19 800 pés', 0, NULL),
  (1897, '50 800 pés', 0, NULL),
  (1898, '(–5, 0).', 0, NULL),
  (1898, '(–3, 1).', 1, NULL),
  (1898, '(–2, 1).', 0, NULL),
  (1898, '(0, 4).', 0, NULL),
  ...
  (1899, '21,0%', 0, NULL),
  (1900, '1 000 m.', 0, NULL),
  (1900, '1 000 √3 m.', 1, NULL),
  (1900, '2 000 √3/3 m.', 0, NULL),
  (1900, '2 000 m', 0, NULL),
  (1900, '2 000 √3 m.', 0, NULL),
  (1901, 'Y = 4 300x', 0, NULL),
  (1901, 'Y = 884 905x', 0, NULL),
  (1901, 'Y = 872 005 + 4 300x', 1, NULL),
  (1901, 'Y = 876 305 + 4 300x', 0, NULL),
  (1901, 'Y = 880 605 + 4 300x', 0, NULL),
  (1902, 'R$ 0,27.', 0, NULL),
  (1902, 'R$ 0,29.', 1, NULL),
  (1902, 'R$ 0,32.', 0, NULL),
  (1902, 'R$ 0,34.', 0, NULL),
  (1902, 'R$ 0,61.', 0, NULL),
  (1903, '100n + 350 = 120n + 150', 1, NULL),
  (1903, '100n + 150 = 120n + 350', 0, NULL),
  (1903, '100(n + 350) = 120(n + 150)', 0, NULL),
  (1903, '100(n + 350 000) = 120(n + 150 000)', 0, NULL),
  (1903, '350(n + 100 000) = 150(n + 120 000)', 0, NULL),
  (1904, 'R$ 4 222,22.', 0, NULL),
  (1904, 'R$ 4 523,80.', 0, NULL),
  (1904, 'R$ 5 000,00.', 1, NULL),
  (1904, 'D R$ 13 300,00.', 0, NULL),
  (1904, 'R$ 17 100,00.', 0, NULL),
  (1905, '250.', 0, NULL),
  (1905, '25.', 1, NULL),
  (1905, '2,5.', 0, NULL),
  (1905, '0,25.', 0, NULL),
  ...
  (1911, '120 mL.', 0, NULL),
  (1911, '600 mL.', 0, NULL),
  (1912, 'Arthur, pois a soma que escolheu é a menor.', 0, NULL),
  (1912, 'Bernardo, pois há 7 possibilidades de compor a soma escolhida por ele, contra 4 possibilidades para a escolha de Arthur e 4 possibilidades para a escolha de Caio.', 0, NULL),
  (1912, 'Bernardo, pois há 7 possibilidades de compor a soma escolhida por ele, contra 5 possibilidades para a escolha de Arthur e 4 possibilidades para a escolha de Caio.', 1, NULL),
  (1912, 'Caio, pois há 10 possibilidades de compor a soma escolhida por ele, contra 5 possibilidades para a escolha de Arthur e 8 possibilidades para a escolha de Bernardo.', 0, NULL),
  (1912, 'Caio, pois a soma que escolheu é a maior.', 0, NULL),
  (1913, 'Duílio tem o IMC 26,7 e Sandra tem o IMC 26,6, estando ambos na categoria de sobrepeso.', 0, NULL),
  (1913, 'Duílio tem o IMC 27,3 e Sandra tem o IMC 29,1estando ambos na categoria de sobrepeso.', 1, NULL),
  (1913, 'Duílio tem o IMC 27,3 e Sandra tem o IMC 26,6, estando ambos na categoria de sobrepeso.', 0, NULL),
  (1913, 'Duílio tem o IMC 25,6, estando na categoria de sobrepeso, e Sandra tem o IMC 24,7, estando na categoria de peso normal.', 0, NULL),
  (1913, 'Duílio tem o IMC 25,1, estando na categoria de sobrepeso, e Sandra tem o IMC 22,6, estando na categoria de peso normal.', 0, NULL),
  (1914, '8%.', 0, NULL),
  (1914, '9%.', 0, NULL),
  (1914, '11%.', 1, NULL),
  (1914, '12%.', 0, NULL),
  (1914, '22%.', 0, NULL),
  (1915, 'K, I e F.', 0, NULL),
  (1915, 'K, J, I, G, L e F.', 0, NULL),
  (1915, 'K, L, G, I, J, H e F.', 1, NULL),
  (1915, 'K, J, H, I, G, L e F.', 0, NULL),
  (1915, 'K, L, G, I, H, J e F.', 0, NULL),
  (1916, '1998 e 2001', 0, NULL),
  (1916, '2001 e 2003', 0, NULL),
  (1916, '2003 e 2006', 1, NULL),
  (1916, '2003 e 2007', 0, NULL),
  (1916, '2003 e 2008', 0, NULL),
  (1917, '24', 0, NULL),
  (1917, '31', 0, NULL),
  (1917, '32', 0, NULL),
  (1917, '88', 0, NULL),
  (1917, '89', 1, NULL),
  (1918, 'Menos de 23.', 0, NULL),
  (1918, 'Mais de 23 e menos de 25.', 0, NULL),
  (1918, 'Mais de 50 e menos de 75.', 1, NULL),
  (1918, 'Mais de 100 e menos de 190.', 0, NULL),
  (1918, 'Mais de 200.', 0, NULL),
  (1919, '20 000 vezes a luminosidade do Sol.', 1, NULL),
  (1919, '28 000 vezes a luminosidade do Sol.', 0, NULL),
  (1919, '28 850 vezes a luminosidade do Sol.', 0, NULL),
  (1919, '30 000 vezes a luminosidade do Sol.', 0, NULL),
  (1919, '50 000 vezes a luminosidade do Sol.', 0, NULL),
  (1920, 'Escolher qualquer um dos investimentos A, B ou C, pois as suas rentabilidades anuais são iguais a 36%.', 0, NULL),
  (1920, 'Escolher os investimentos A ou C, pois suas rentabilidades anuais são iguais a 39%.', 0, NULL),
  (1920, 'Escolher o investimento A, pois a sua rentabilidade anual é maior que as rentabilidades anuais dos investimentos B e C.', 1, NULL),
  (1920, 'Escolher o investimento B, pois sua rentabilidade de 36% é maior que as rentabilidades de 3% do investimento A e de 18% do investimento C.', 0, NULL),
  (1920, 'Escolher o investimento C, pois sua rentabilidade de 39% ao ano é maior que a rentabilidade de 36% ao ano dos investimentos A e B.', 0, NULL),
  (1921, 'S = k . b . d', 0, NULL),
  (1921, 'S = b . d²', 0, NULL),
  (1921, 'S = k . b . d²', 1, NULL),
  (1921, 'S = (k . b)/d', 0, NULL),
  ...
  (1925, '1:700', 0, NULL),
  (1925, '1:7 000', 0, NULL),
  (1925, '1:70 000', 0, NULL),
  (1925, '1:700 000', 1, NULL),
  (1925, '1:7 000 000', 0, NULL),
  (1926, '300%.', 0, NULL),
  (1926, '200%.', 0, NULL),
  (1926, '150%.', 0, NULL),
  (1926, '100%.', 0, NULL),
  (1926, '50%.', 1, NULL),
  (1927, '600, 550, 350', 0, NULL),
  (1927, '300, 300, 150', 1, NULL),
  (1927, '300, 250, 200', 0, NULL),
  (1927, '200, 200, 100', 0, NULL),
  (1927, '100, 100, 50', 0, NULL),
  (1928, '0,09.', 0, NULL),
  (1928, '0,12.', 0, NULL),
  (1928, '0,14.', 0, NULL),
  (1928, '0,15.', 1, NULL),
  ...
  (1929, '15 − 5y', 0, NULL),
  (1929, '−5y − 3x', 0, NULL),
  (1929, '5y + 3x − xy', 1, NULL),
  (1930, '12 000.', 0, NULL),
  (1930, '12 600.', 0, NULL),
  (1930, '13 200.', 0, NULL),
  (1930, '13 800.', 1, NULL),
  (1930, '15 000.', 0, NULL),
  (1932, '10 alunos a mais do que possíveis respostas distintas.', 1, NULL),
  (1932, '20 alunos a mais do que possíveis respostas distintas.', 0, NULL),
  (1932, '119 alunos a mais do que possíveis respostas distintas.', 0, NULL),
  (1932, '260 alunos a mais do que possíveis respostas distintas.', 0, NULL),
  (1932, '270 alunos a mais do que possíveis respostas distintas.', 0, NULL),
  (1933, 'I', 0, NULL),
  (1933, 'II', 0, NULL),
  (1933, 'III', 0, NULL),
  (1933, 'IV', 1, NULL),
  ...
  (1934, 'Branca.', 0, NULL),
  (1934, 'Verde.', 0, NULL),
  (1934, 'Vermelha.', 1, NULL),
  (1935, '3 534,85.', 0, NULL),
  (1935, '3 544,20.', 0, NULL),
  (1935, '3 534 850,00.', 0, NULL),
  (1935, '3 534 859,35.', 1, NULL),
  (1935, '3 534 850,39.', 0, NULL),
  (1936, 'Março e abril.', 0, NULL),
  (1936, 'Março e agosto.', 0, NULL),
  (1936, 'Agosto e setembro.', 0, NULL),
  (1936, 'Junho e setembro.', 0, NULL),
  (1936, 'Junho e agosto.', 1, NULL),
  (1937, 'Cilindro, prisma de base pentagonal e pirâmide.', 1, NULL),
  (1937, 'Cone, prisma de base pentagonal e pirâmide.', 0, NULL),
  (1937, 'Cone, tronco de pirâmide e pirâmide.', 0, NULL),
  (1937, 'Cilindro, tronco de pirâmide e prisma.', 0, NULL),
  (1937, 'Cilindro, prisma e tronco de cone.', 0, NULL),
  (1938, '21.', 0, NULL),
  (1938, '24.', 1, NULL),
  (1938, '26.', 0, NULL),
  (1938, '28.', 0, NULL),
  ...
  (1939, '2005.', 0, NULL),
  (1939, '2007.', 1, NULL),
  (1942, '0,20 m e 1,45 m.', 0, NULL),
  (1942, '0,20 m e 1,40 m.', 0, NULL),
  (1942, '0,25 m e 1,35 m.', 0, NULL),
  (1942, '0,25 m e 1,30 m.', 0, NULL),
  (1942, '0,45 m e 1,20 m.', 1, NULL),
  (1943, '20', 0, NULL),
  (1943, '21', 0, NULL),
  (1943, '24', 0, NULL),
  (1943, '25', 0, NULL),
  ...
  (1945, '89', 0, NULL),
  (1945, '91', 0, NULL),
  (1946, 'O nível subiria 0,2 cm, fazendo a água ficar com 20,2 cm de altura.', 0, NULL),
  (1946, 'O nível subiria 1 cm, fazendo a água ficar com 21 cm de altura.', 0, NULL),
  (1946, 'O nível subiria 2 cm, fazendo a água ficar com 22 cm de altura.', 1, NULL),
  (1946, 'O nível subiria 8 cm, fazendo a água transbordar.', 0, NULL),
  (1946, 'O nível subiria 20 cm, fazendo a água transbordar.', 0, NULL),
  (1947, 'Quatro unidades do tipo A e nenhuma unidade do tipo B.', 0, NULL),
  (1947, 'Três unidades do tipo A e uma unidade do tipo B.', 0, NULL),
  (1947, 'Duas unidades do tipo A e duas unidades do tipo B.', 1, NULL),
  (1947, 'Uma unidade do tipo A e três unidades do tipo B.', 0, NULL),
  (1947, 'Nenhuma unidade do tipo A e quatro unidades do tipo B.', 0, NULL),
  (1948, 'R$ 22,50', 0, NULL),
  (1948, 'R$ 35,00', 1, NULL),
  (1948, 'R$ 40,00', 0, NULL),
  (1948, 'R$ 42,50', 0, NULL),
  (1948, 'R$ 45,00', 0, NULL),
  (1949, 'Centena.', 0, NULL),
  (1949, 'Dezena de milhar.', 0, NULL),
  (1949, 'Centena de milhar.', 1, NULL),
  (1949, 'Milhão.', 0, NULL),
  (1949, 'Centena de milhão.', 0, NULL),
  (1950, 'Segunda e na terça-feira.', 0, NULL),
  (1950, 'Terça e na quarta-feira.', 1, NULL),
  (1950, 'Terça e na quinta-feira.', 0, NULL),
  (1950, 'Quinta-feira, no sábado e no domingo.', 0, NULL),
  (1950, 'Segunda, na quinta e na sexta-feira.', 0, NULL),
  (1952, '5', 0, NULL),
  (1952, '11', 1, NULL),
  (1952, '13', 0, NULL),
  (1952, '23', 0, NULL),
  ...
  (1957, '124,30°.', 0, NULL),
  (1957, '124,50°.', 0, NULL),
  (1958, '3,25 × 102 km.', 0, NULL),
  (1958, '3,25 × 103 km.', 0, NULL),
  (1958, '3,25 × 104 km.', 0, NULL),
  (1958, '3,25 × 105 km.', 1, NULL),
  (1958, '3,25 × 106 km.', 0, NULL),
  (1959, '24 litros', 0, NULL),
  (1959, '36 litros', 1, NULL),
  (1959, '40 litros', 0, NULL),
  (1959, '42 litros', 0, NULL),
  (1959, '50 litros', 0, NULL),
  (1960, 'Balas W e Pizzaria Y.', 0, NULL),
  (1960, 'Chocolates X e Tecelagem Z.', 0, NULL),
  (1960, 'Pizzaria Y e Alfinetes V.', 0, NULL),
  (1960, 'Pizzaria Y e Chocolates X.', 1, NULL),
  (1960, 'Tecelagem Z e Alfinetes V.', 0, NULL),
  (1961, 'Hipoglicemia.', 0, NULL),
  (1961, 'Normal.', 0, NULL),
  (1961, 'Pré-diabetes.', 0, NULL),
  (1961, 'Diabetes melito.', 1, NULL),
  (1961, 'Hiperglicemia.', 0, NULL),
  (1962, '20,25.', 0, NULL),
  (1962, '4,50.', 0, NULL),
  (1962, '0,71.', 0, NULL),
  (1962, '0,50.', 0, NULL),
  ...
  (1963, '21', 0, NULL),
  (1963, '23', 0, NULL),
  (1964, 'Antônio, já que sua soma é a maior de todas as escolhidas.', 0, NULL),
  (1964, 'José e Antônio, já que há 6 possibilidades tanto para a escolha de José quanto para a escolha de Antônio, e há apenas 4 possibilidades para a escolha de Paulo.', 0, NULL),
  (1964, 'José e Antônio, já que há 3 possibilidades tanto para a escolha de José quanto para a escolha de Antônio, e há apenas 2 possibilidades para a escolha de Paulo.', 0, NULL),
  (1964, 'José, já que há 6 possibilidades para formar sua soma, 5 possibilidades para formar a soma de Antônio e apenas 3 possibilidades para formar a soma de Paulo.', 1, NULL),
  (1964, 'Paulo, já que sua soma é a menor de todas.', 0, NULL),
  (1965, '212 952.', 0, NULL),
  (1965, '229 913.', 1, NULL),
  (1965, '240 621.', 0, NULL),
  (1965, '255 496.', 0, NULL),
  (1965, '298 041.', 0, NULL),
  (1966, '20% menor que V, uma vez que o volume do cubo é diretamente proporcional ao comprimento de seu lado.', 0, NULL),
  (1966, '36% menor que V, porque a área da base diminui de a2 para ((1 − 0,2)a)².', 0, NULL),
  (1966, '48,8% menor que V, porque o volume diminui de a3 para (0,8a)³.', 1, NULL),
  (1966, '51,2% menor que V, porque cada lado diminui para 80% do comprimento original.', 0, NULL),
  (1966, '60% menor que V, porque cada lado diminui 20%.', 0, NULL),
  (1967, '20% menor que V, uma vez que o volume do cubo é diretamente proporcional ao comprimento de seu lado.', 0, NULL),
  (1967, '36% menor que V, porque a área da base diminui de a2 para ((1 − 0,2)a)².', 0, NULL),
  (1967, '48,8% menor que V, porque o volume diminui de a3 para (0,8a)³.', 1, NULL),
  (1967, '51,2% menor que V, porque cada lado diminui para 80% do comprimento original.', 0, NULL),
  (1967, '60% menor que V, porque cada lado diminui 20%.', 0, NULL),
  (1968, 'Menor que 100 m²', 0, NULL),
  (1968, 'Entre 100 m² e 300 m²', 0, NULL),
  (1968, 'Entre 300 m² e 500 m²', 0, NULL),
  (1968, 'Entre 500 m² e 700 m²', 0, NULL),
  (1968, 'Maior que 700 m²', 1, NULL),
  (1969, '0,25 ponto maior.', 0, NULL),
  (1969, '1,00 ponto maior.', 1, NULL),
  (1969, '1,00 ponto menor.', 0, NULL),
  (1969, '1,25 ponto maior.', 0, NULL),
  (1969, '2,00 pontos menor.', 0, NULL),
  (1971, '0,2', 0, NULL),
  (1971, '1,2', 0, NULL),
  (1971, '1,4', 1, NULL),
  (1971, '12,9', 0, NULL),
  ...
  (1979, '11', 0, NULL),
  (1979, '12', 0, NULL),
  (1980, '300 tijolos', 0, NULL),
  (1980, '360 tijolos', 0, NULL),
  (1980, '400 tijolos', 0, NULL),
  (1980, '480 tijolos', 1, NULL),
  (1980, '600 tijolos', 0, NULL),
  (1981, '497,25.', 0, NULL),
  (1981, '500,85.', 0, NULL),
  (1981, '502,87.', 0, NULL),
  (1981, '558,75.', 1, NULL),
  ...
  (1987, '3,0', 0, NULL),
  (1987, '3,8', 0, NULL),
  (1988, 'R$ 900,00.', 0, NULL),
  (1988, 'R$ 1 200,00.', 1, NULL),
  (1988, 'R$ 2 100,00.', 0, NULL),
  (1988, 'R$ 3 900,00.', 0, NULL),
  (1988, 'R$ 5 100,00.', 0, NULL),
  (1989, '1,75', 0, NULL),
  (1989, '2,00', 1, NULL),
  (1989, '2,33', 0, NULL),
  (1989, '4,00', 0, NULL),
  ...
  (1997, '64%', 0, NULL),
  (1997, '96%', 0, NULL),
  (1998, 'Excelente.', 0, NULL),
  (1998, 'Bom.', 1, NULL),
  (1998, 'Regular.', 0, NULL),
  (1998, 'Ruim.', 0, NULL),
  (1998, 'Péssimo.', 0, NULL),
  (1999, 'Caio e Eduardo.', 1, NULL),
  (1999, 'Arthur e Eduardo.', 0, NULL),
  (1999, 'Bruno e Caio.', 0, NULL),
  (1999, 'Arthur e Bruno.', 0, NULL),
  (1999, 'Douglas e Eduardo.', 0, NULL),
  (2000, '0,83', 0, NULL),
  (2000, '1,20', 0, NULL),
  (2000, '12,03', 1, NULL),
  (2000, '104,73', 0, NULL),
  (2000, '120,34', 0, NULL),
  (2001, '5X − 3Y + 15 = 0', 0, NULL),
  (2001, '5X − 2Y + 10 = 0', 1, NULL),
  (2001, '3X − 3Y + 15 = 0', 0, NULL),
  (2001, '3X − 2Y + 15 = 0', 0, NULL),
  (2001, '3X − 2Y + 10 = 0', 0, NULL),
  (2002, '19,0', 0, NULL),
  (2002, '19,8', 0, NULL),
  (2002, '20,0', 0, NULL),
  (2002, '38,0', 1, NULL),
  ...
  (2003, '35', 0, NULL),
  (2003, '31', 0, NULL),
  (2004, 'Menor que 10.', 0, NULL),
  (2004, 'Maior que 10 e menor que 20.', 0, NULL),
  (2004, 'Maior que 20 e menor que 30.', 0, NULL),
  (2004, 'Maior que 30 e menor que 40.', 1, NULL),
  (2004, 'Maior que 40.', 0, NULL),
  (2005, '(65 ; 35).', 0, NULL),
  (2005, '(53 ; 30).', 0, NULL),
  (2005, '(45 ; 35).', 0, NULL),
  (2005, '(50 ; 20).', 0, NULL),
  (2005, '(50 ; 30).', 1, NULL),
  (2006, 'Um tronco de cone e um cilindro.', 0, NULL),
  (2006, 'Um cone e um cilindro.', 0, NULL),
  (2006, 'Um tronco de pirâmide e um cilindro.', 0, NULL),
  (2006, 'Dois troncos de cone.', 1, NULL),
  (2006, 'Dois cilindros.', 0, NULL),
  (2007, 'Finlândia.', 0, NULL),
  (2007, 'Holanda.', 0, NULL),
  (2007, 'Israel.', 1, NULL),
  (2007, 'México.', 0, NULL),
  (2007, 'Rússia.', 0, NULL),
  ...
  (2011, '1,70.', 0, NULL),
  (2011, '1,80.', 0, NULL),
  (2012, 'Norte, Centro-Oeste e Sul.', 0, NULL),
  (2012, 'Norte, Nordeste e Sudeste.', 1, NULL),
  (2012, 'Nordeste, Norte e Sul.', 0, NULL),
  (2012, 'Nordeste, Sudeste e Sul.', 0, NULL),
  (2012, 'Centro-Oeste, Sul e Sudeste.', 0, NULL),
  (2013, '1/8', 0, NULL),
  (2013, '7/8', 0, NULL),
  (2013, '8/7', 0, NULL),
  (2013, '8/9', 1, NULL),
  ...
  (2020, '(x+ 1).(y + 1)', 0, NULL),
  (2020, 'X . y . z - 1', 0, NULL),
  (2020, '(x + 1).(y + 1).z', 0, NULL),
  (2020, '(x + 1).(y + 1).(z + 1) - 1', 1, NULL),
  (2021, '3.', 1, NULL),
  (2021, '5.', 0, NULL),
  (2021, '6.', 0, NULL),
  (2021, '8.', 0, NULL),
  (2021, '10.', 0, NULL),
  (2023, '1 hora.', 0, NULL),
  (2023, '1 hora e 15 minutos.', 1, NULL),
  (2023, '5 horas.', 0, NULL),
  (2023, '6 horas.', 0, NULL),
  (2023, '6 horas e 15 minutos.', 0, NULL),
  (2024, '25.', 0, NULL),
  (2024, '33.', 0, NULL),
  (2024, '42.', 0, NULL),
  (2024, '45.', 0, NULL),
  ...
  (2026, '54%', 0, NULL),
  (2026, '18%', 0, NULL),
  (2027, 'R$ 114 285,00', 0, NULL),
  (2027, 'R$ 130 000,00', 1, NULL),
  (2027, 'R$ 160 000,00', 0, NULL),
  (2027, 'R$ 210 000,00', 0, NULL),
  (2027, 'R$ 213 333,00', 0, NULL),
  (2028, 'I', 0, NULL),
  (2028, 'II', 0, NULL),
  (2028, 'III', 0, NULL),
  (2028, 'IV', 1, NULL),
  ...
  (2030, '6 000.', 0, NULL),
  (2030, '60 000.', 0, NULL),
  (2030, '6 000 000.', 1, NULL),
  (2031, 'Branca e os de número 38.', 1, NULL),
  (2031, 'Branca e os de número 37.', 0, NULL),
  (2031, 'Branca e os de número 36.', 0, NULL),
  (2031, 'Preta e os de número 38.', 0, NULL),
  (2031, 'Preta e os de número 37.', 0, NULL),
  (2032, '47,5%.', 0, NULL),
  (2032, '85,0%.', 0, NULL),
  (2032, '86,3%.', 0, NULL),
  (2032, '94,4%.', 0, NULL),
  ...
  (2044, '5π d', 1, NULL),
  (2044, '10π d', 0, NULL),
  (2045, '1,8 t; 8,4 t; 1,8 t.', 0, NULL),
  (2045, '3,0 t; 6,0 t; 3,0 t.', 0, NULL),
  (2045, '2,4 t; 7,2 t; 2,4 t.', 1, NULL),
  (2045, '3,6 t; 4,8 t; 3,6 t.', 0, NULL),
  (2045, '4,2 t; 3,6 t; 4,2 t.', 0, NULL),
  (2046, '364.', 0, NULL),
  (2046, '463.', 0, NULL),
  (2046, '3 064.', 1, NULL),
  (2046, '3 640.', 0, NULL),
  ...
  (2049, '[50 ; 90].', 0, NULL),
  (2049, '[70 ; 90].', 0, NULL),
  (2050, 'Terça-feira.', 1, NULL),
  (2050, 'Quarta-feira.', 0, NULL),
  (2050, 'Quinta-feira.', 0, NULL),
  (2050, 'Sexta-feira.', 0, NULL),
  (2050, 'Domingo.', 0, NULL),
  (2051, '8', 0, NULL),
  (2051, '10', 1, NULL),
  (2051, '16', 0, NULL),
  (2051, '18', 0, NULL),
  (2051, '24', 0, NULL),
  (2052, 'Retirar 16 células.', 1, NULL),
  (2052, 'Retirar 40 células.', 0, NULL),
  (2052, 'Acrescentar 5 células.', 0, NULL),
  (2052, 'Acrescentar 20 células.', 0, NULL),
  (2052, 'Acrescentar 40 células.', 0, NULL),
  (2053, 'R$ 166,00.', 0, NULL),
  (2053, 'R$ 156,00.', 1, NULL),
  (2053, 'R$ 84,00.', 0, NULL),
  (2053, 'R$ 46,00.', 0, NULL),
  (2053, 'R$ 24,00.', 0, NULL),
  (2054, '16h.', 0, NULL),
  ...
  (2057, '35', 0, NULL),
  (2057, '60', 0, NULL),
  (2058, 'De 20 a 100.', 0, NULL),
  (2058, 'De 80 a 130.', 0, NULL),
  (2058, 'De 100 a 160.', 0, NULL),
  (2058, 'De 0 a 20 e de 100 a 160.', 1, NULL),
  (2058, 'De 40 a 80 e de 130 a 160.', 0, NULL),
  (2059, '9', 0, NULL),
  (2059, '7', 0, NULL),
  (2059, '5', 0, NULL),
  (2059, '4', 0, NULL),
  (2059, '3', 1, NULL),
  (2060, 'Correios e SMS.', 0, NULL),
  (2060, 'Internet e Correios.', 1, NULL),
  (2060, 'Internet e internet.', 0, NULL),
  (2060, 'Internet e mídias sociais.', 0, NULL),
  (2060, 'Rádio/TV e rádio/TV.', 0, NULL),
  (2061, '450.', 0, NULL),
  (2061, '500.', 0, NULL),
  (2061, '600.', 1, NULL),
  (2061, '750.', 0, NULL),
  ...
  (2063, '20,85.', 1, NULL),
  (2063, '20,90.', 0, NULL),
  (2064, 'Aumento de 5 800 cm².', 1, NULL),
  (2064, 'Aumento de 75 400 cm².', 0, NULL),
  (2064, 'Aumento de 214 600 cm².', 0, NULL),
  (2064, 'Diminuição de 63 800 cm².', 0, NULL),
  (2064, 'Diminuição de 272 600 cm².', 0, NULL),
  (2065, '0,5', 0, NULL),
  (2065, '1,0', 0, NULL),
  (2065, '2,0', 1, NULL),
  (2065, '3,5', 0, NULL),
  ...
  (2068, '24', 0, NULL),
  (2068, '30', 0, NULL),
  (2069, 'R$ 0,50 ≤ p < R$ 1,50', 1, NULL),
  (2069, 'R$ 1,50 ≤ p < R$ 2,50', 0, NULL),
  (2069, 'R$ 2,50 ≤ p < R$ 3,50', 0, NULL),
  (2069, 'R$ 3,50 ≤ p < R$ 4,50', 0, NULL),
  (2069, 'R$ 4,50 ≤ p < R$ 5,50', 0, NULL),
  (2070, 'I.', 1, NULL),
  (2070, 'II.', 0, NULL),
  (2070, 'III.', 0, NULL),
  (2070, 'IV.', 0, NULL),
  (2070, 'V.', 0, NULL),
  (2071, 'P(t) = 0,5 · t-1 + 8 000', 0, NULL),
  (2071, 'P(t) = 50 · t-1 + 8 000', 0, NULL),
  (2071, 'P(t) = 4 000 · t-1 + 8 000', 0, NULL),
  (2071, 'P(t) = 8 000 · (0,5)t - 1', 0, NULL),
  (2071, 'P(t) = 8 000 · (1,5)t - 1', 1, NULL),
  (2072, 'Triângulo.', 0, NULL),
  (2072, 'Losango.', 0, NULL),
  (2072, 'Pentágono.', 1, NULL),
  (2072, 'Hexágono.', 0, NULL),
  (2072, 'Octógono.', 0, NULL),
  (2074, '8π.', 1, NULL),
  (2074, '12π.', 0, NULL),
  (2074, '16π.', 0, NULL),
  (2074, '32π.', 0, NULL),
  (2074, '64π.', 0, NULL),
  (2075, '2 075,00.', 0, NULL),
  (2075, '2 093,00.', 0, NULL),
  (2075, '2 138,00.', 0, NULL),
  (2075, '2 255,00.', 1, NULL),
  (2075, '2 300,00.', 0, NULL),
  (2076, '4,129 x 10³', 0, NULL),
  (2076, '4,129 x 106', 0, NULL),
  (2076, '4,129 x 109', 1, NULL),
  (2076, '4,129 x 1012', 0, NULL),
  (2076, '4,129 x 1015', 0, NULL),
  (2077, '15.', 0, NULL),
  (2077, '20.', 1, NULL),
  (2077, '30.', 0, NULL),
  (2077, '36.', 0, NULL),
  ...
  (2078, '240,40', 0, NULL),
  (2078, '548,11', 0, NULL),
  (2078, '1 723,67', 0, NULL),
  (2078, '4 026,70', 0, NULL),
  (2078, '5 216,68', 1, NULL),
  (2079, '4,9 e 7,6.', 0, NULL),
  (2079, '8,6 e 9,8.', 0, NULL),
  (2079, '14,2 e 15,4.', 0, NULL),
  (2079, '26,4 e 40,8.', 1, NULL),
  (2079, '27,5 e 42,5.', 0, NULL),
  (2080, '2', 1, NULL),
  (2080, '1', 0, NULL),
  (2080, '11/3', 0, NULL),
  (2080, '4/3', 0, NULL),
  (2080, '2/3', 0, NULL),
  (2081, '105 peças.', 0, NULL),
  (2081, '120 peças.', 0, NULL),
  (2081, '210 peças.', 0, NULL),
  (2081, '243 peças.', 0, NULL),
  (2081, '420 peças.', 1, NULL),
  (2082, '25', 1, NULL),
  (2082, '15', 0, NULL),
  (2082, '13', 0, NULL),
  (2082, '12', 0, NULL),
  ...
  (2088, '84,6.', 0, NULL),
  (2088, '106,6.', 0, NULL),
  (2089, 'A, B, C, E, D.', 0, NULL),
  (2089, 'B, A, C, E, D.', 1, NULL),
  (2089, 'C, B, E, A, D.', 0, NULL),
  (2089, 'C, B, E, D, A.', 0, NULL),
  (2089, 'E, C, D, B, A.', 0, NULL),
  (2090, '10,8.', 0, NULL),
  (2090, '12,0.', 0, NULL),
  (2090, '32,4.', 0, NULL),
  (2090, '108,0.', 1, NULL),
  ...
  (2092, '3,07.', 0, NULL),
  (2092, '3,10', 0, NULL),
  (2093, 'Muito baixa.', 0, NULL),
  (2093, 'Baixa.', 0, NULL),
  (2093, 'Média.', 0, NULL),
  (2093, 'Alta.', 1, NULL),
  (2093, 'Muito alta.', 0, NULL),
  (2094, '8b³', 0, NULL),
  (2094, '6b³', 1, NULL),
  (2094, '5b³', 0, NULL),
  (2094, '4b³', 0, NULL),
  ...
  (2099, '18', 1, NULL),
  (2099, '21', 0, NULL),
  (2100, '22,00 cm, 12,00 cm e 5,00 cm.', 1, NULL),
  (2100, '27,50 cm, 15,00 cm e 6,25 cm.', 0, NULL),
  (2100, '34,37 cm, 18,75 cm e 7,81 cm.', 0, NULL),
  (2100, '35,20 cm, 19,20 cm e 8,00 cm.', 0, NULL),
  (2100, '44,00 cm, 24,00 cm e 10,00 cm.', 0, NULL),
  (2101, '53', 0, NULL),
  (2101, '94', 0, NULL),
  (2101, '113', 0, NULL),
  (2101, '135', 1, NULL),
  ...
  (2103, 'I e III', 0, NULL),
  (2103, 'I e IV', 0, NULL),
  (2103, 'II e III', 1, NULL),
  (2103, 'II e IV', 0, NULL),
  (2103, 'III e IV', 0, NULL),
  (2104, '205/55R15.', 0, NULL),
  (2104, '175/65R15.', 0, NULL),
  (2104, '175/75R15.', 0, NULL),
  (2104, '175/80R15.', 0, NULL),
  (2104, '185/60R15', 1, NULL),
  (2105, '3 e C', 0, NULL),
  (2105, '4 e C', 0, NULL),
  (2105, '4 e D', 1, NULL),
  (2105, '4 e E', 0, NULL),
  (2105, '5 e C', 0, NULL),
  (2106, '7,5 e 14,5.', 0, NULL),
  (2106, '9,0 e 16,0.', 1, NULL),
  (2106, '9,3 e 16,3.', 0, NULL),
  (2106, '10,0 e 17,0.', 0, NULL),
  (2106, '13,5 e 20,5.', 0, NULL),
  (2107, 'I', 0, NULL),
  (2107, 'II', 0, NULL),
  (2107, 'IV', 0, NULL),
  (2107, 'V', 1, NULL),
  ...
  (2111, '460 171.', 1, NULL),
  (2111, '610 741.', 0, NULL),
  (2112, 'Diminuir em 2 unidades', 0, NULL),
  (2112, 'Diminuir em 4 unidades', 0, NULL),
  (2112, 'Aumentar em 2 unidades.', 1, NULL),
  (2112, 'Aumentar em 4 unidades.', 0, NULL),
  (2112, 'Aumentar em 8 unidades.', 0, NULL),
  (2114, '23,5%', 1, NULL),
  (2114, '21,2%', 0, NULL),
  (2114, '19,0%', 0, NULL),
  (2114, '11,8%', 0, NULL),
  ...
  (2120, '31', 0, NULL),
  (2120, '35', 1, NULL),
  (2121, '2 meses e meio.', 1, NULL),
  (2121, '3 meses e meio.', 0, NULL),
  (2121, '1 mês e meio.', 0, NULL),
  (2121, '4 meses.', 0, NULL),
  (2121, '1 mês.', 0, NULL),
  (2122, '156', 0, NULL),
  (2122, '180', 1, NULL),
  ...
  (2123, '200', 1, NULL),
  (2123, '400', 0, NULL),
  (2124, '1,4 × 10³  m³', 0, NULL),
  (2124, '1,8 × 10³  m³', 0, NULL),
  (2124, '2,0 × 10³  m³', 0, NULL),
  (2124, '3,2 × 10³  m³', 1, NULL),
  (2124, '6,0 × 10³  m³', 0, NULL),
  (2125, 'Janeiro', 1, NULL),
  (2125, 'Fevereiro', 0, NULL),
  (2125, 'Agosto', 0, NULL),
  (2125, 'Novembro', 0, NULL),
  (2125, 'Dezembro', 0, NULL),
  (2126, 'DB < dA < dC', 1, NULL),
  (2126, 'DB = dA < dC', 0, NULL),
  (2126, 'DC < dB = dA', 0, NULL),
  (2126, 'DB < dC < dA', 0, NULL),
  (2126, 'DC < dB < dA', 0, NULL),
  (2127, '570', 0, NULL),
  (2127, '500', 1, NULL),
  (2127, '450', 0, NULL),
  ...
  (2137, '34', 0, NULL),
  (2137, '40', 0, NULL),
  (2138, 'Quadrados, apenas', 0, NULL),
  (2138, 'Triângulos e quadrados, apenas', 0, NULL),
  (2138, 'Triângulos, quadrados e trapézios, apenas', 0, NULL),
  (2138, 'Triângulos, quadrados, trapézios e quadriláteros irregulares, apenas.', 0, NULL),
  (2138, 'Triângulos, quadrados, trapézios, quadriláteros irregulares e pentágonos, apenas.', 1, NULL),
  (2139, 'De 0 a 10.', 0, NULL),
  (2139, 'De 5 a 10.', 1, NULL),
  (2139, 'De 5 a 15.', 0, NULL),
  (2139, 'De 15 a 25.', 0, NULL),
  (2139, 'De 0 a 25.', 0, NULL),
  (2140, 'I', 1, NULL),
  (2140, 'II', 0, NULL),
  (2140, 'III', 0, NULL),
  (2140, 'IV', 0, NULL),
  ...
  (2142, 'F5.', 0, NULL),
  (2143, 'E1 = E2 + 2', 0, NULL),
  (2143, 'E1 = 10².E2', 0, NULL),
  (2143, 'E1 = 10³.E2', 1, NULL),
  (2143, 'E1 = 109/7.E2', 0, NULL),
  (2143, 'E1 = 9/7.E2', 0, NULL),
  (2144, 'E1 = E2 + 2', 0, NULL),
  (2144, 'E1 = 10².E2', 0, NULL),
  (2144, 'E1 = 10³.E2', 1, NULL),
  (2144, 'E1 = 109/7.E2', 0, NULL),
  (2144, 'E1 = 9/7.E2', 0, NULL),
  (2146, '12', 0, NULL),
  (2146, '14', 0, NULL),
  (2146, '15', 0, NULL),
  (2146, '16', 1, NULL),
  ...
  (2154, '36.', 0, NULL),
  (2154, '40.', 0, NULL),
  (2155, 'Tetraedro.', 0, NULL),
  (2155, 'Pirâmide retangular.', 0, NULL),
  (2155, 'Tronco de pirâmide retangular.', 0, NULL),
  (2155, 'Prisma quadrangular reto.', 0, NULL),
  (2155, 'Prisma triangular reto.', 1, NULL),
  (2156, 'P.', 0, NULL),
  (2156, 'Q.', 1, NULL),
  (2156, 'R.', 0, NULL),
  (2156, 'S.', 0, NULL),
  (2156, 'T.', 0, NULL),
  (2157, '90° no sentido horário.', 0, NULL),
  (2157, '135° no sentido horário.', 1, NULL),
  (2157, '180° no sentido anti-horário.', 0, NULL),
  (2157, '270° no sentido anti-horário', 0, NULL),
  (2157, '315° no sentido horário.', 0, NULL),
  (2158, '7,00.', 0, NULL),
  (2158, '7,38.', 0, NULL),
  (2158, '7,50.', 0, NULL),
  (2158, '8,25.', 1, NULL),
  ...
  (2161, '4.', 0, NULL),
  (2161, '5.', 0, NULL),
  (2162, 'Apenas o aluno Y', 0, NULL),
  (2162, 'Apenas o aluno Z', 1, NULL),
  (2162, 'Apenas os alunos x e y', 0, NULL),
  (2162, 'Apenas os alunos x e z', 0, NULL),
  (2162, 'Os alunos x, y, z', 0, NULL),
  (2163, 'I', 0, NULL),
  (2163, 'II', 0, NULL),
  (2163, 'III', 0, NULL),
  (2163, 'IV', 1, NULL),
  ...
  (2168, '25 E 25', 1, NULL),
  (2168, '50 E 50', 0, NULL),
  (2169, 'Semirreta oblíqua.', 0, NULL),
  (2169, 'Semirreta horizontal.', 0, NULL),
  (2169, 'Ramo de parábola.', 0, NULL),
  (2169, 'Arco de circunferência.', 0, NULL),
  (2169, 'Ramo de hipérbole.', 1, NULL),
  (2170, '2,25', 0, NULL),
  (2170, '3,90', 0, NULL),
  (2170, '4,35', 1, NULL),
  (2170, '4,40', 0, NULL),
  ...
  (2172, '2/15.', 0, NULL),
  (2172, '8/35.', 1, NULL),
  (2173, 'P(t) = 99 + 21cos(3πt)', 1, NULL),
  (2173, 'P(t) = 78 + 42cos(3πt)', 0, NULL),
  (2173, 'P(t) = 99 + 21cos(2πt)', 0, NULL),
  (2173, 'P(t) = 99 + 21cos(t)', 0, NULL),
  (2173, 'P(t) = 78 + 42cos(t)', 0, NULL),
  (2174, '5 - √91/2', 0, NULL),
  (2174, '10 - √91', 0, NULL),
  (2174, '1', 1, NULL),
  (2174, '4', 0, NULL),
  ...
  (2177, '15 °C', 0, NULL),
  (2177, '19 °C', 1, NULL),
  (2178, '12, 24 e 36.', 1, NULL),
  (2178, '6, 12 e 18.', 0, NULL),
  (2178, '2, 4 e 6.', 0, NULL),
  (2178, '300, 1200 e 2700.', 0, NULL),
  (2178, '600, 2400 e 5400.', 0, NULL),
  (2179, '1.', 1, NULL),
  (2179, '2.', 0, NULL),
  (2179, '4.', 0, NULL),
  (2179, '5.', 0, NULL),
  (2179, '6.', 0, NULL),
  (2180, '20/0,075', 0, NULL),
  (2180, '20/0,75', 1, NULL),
  (2180, '20/7,5', 0, NULL),
  (2180, '20 x 0,075', 0, NULL),
  (2180, '20 x 0,75', 0, NULL),
  (2181, '8,1%', 0, NULL),
  (2181, '8,0%', 1, NULL),
  (2181, '7,9%', 0, NULL),
  (2181, '7,7%', 0, NULL),
  ...
  (2186, '0,600', 0, NULL),
  (2186, '0,800', 0, NULL),
  (2187, '19 h 30 min e 20 h 10 min.', 0, NULL),
  (2187, '19 h 20 min e 19 h 30 min.', 0, NULL),
  (2187, '19 h 10 min e 19 h 20 min.', 0, NULL),
  (2187, '19 h e 19 h 10 min.', 1, NULL),
  (2187, '18 h 40 min e 19 h.', 0, NULL),
  (2188, '19 h 30 min e 20 h 10 min.', 0, NULL),
  (2188, '19 h 20 min e 19 h 30 min.', 0, NULL),
  (2188, '19 h 10 min e 19 h 20 min.', 0, NULL),
  (2188, '19 h e 19 h 10 min.', 1, NULL),
  (2188, '18 h 40 min e 19 h.', 0, NULL),
  (2189, '56ª', 0, NULL),
  (2189, '55ª', 0, NULL),
  (2189, '52ª', 1, NULL),
  (2189, '51ª', 0, NULL),
  ...
  (2190, 'X² + y² =16', 0, NULL),
  (2190, 'X² + (y-2)² = 4', 0, NULL),
  (2190, '(x -2 )² + ( y - 2 )² = 8', 1, NULL),
  (2192, 'R$512 000,00.', 0, NULL),
  (2192, 'R$520 000,00.', 0, NULL),
  (2192, 'R$528 000,00.', 1, NULL),
  (2192, 'R$552 000,00.', 0, NULL),
  (2192, 'R$584 000,00.', 0, NULL),
  (2193, '29,25 e 0,75', 0, NULL),
  (2193, '28,75 e 1,25', 1, NULL),
  (2193, '28,50 e 1,50', 0, NULL),
  (2193, '27,75 e 2,25', 0, NULL),
  (2193, '25,00 e 5,00', 0, NULL),
  (2194, '1.', 0, NULL),
  (2194, '2.', 1, NULL),
  (2194, '3.', 0, NULL),
  (2194, '4.', 0, NULL),
  ...
  (2195, '2,22.', 0, NULL),
  (2197, 'Ótima.', 0, NULL),
  (2197, 'Próxima de ótima.', 0, NULL),
  (2197, 'Limite', 0, NULL),
  (2197, 'Alta.', 1, NULL),
  (2197, 'Muito alta.', 0, NULL),
  (2199, 'Elevado em 40 cm.', 1, NULL),
  (2199, 'Elevado em 50 cm.', 0, NULL),
  (2199, 'Mantido no mesmo nível.', 0, NULL),
  (2199, 'Rebaixado em 40 cm.', 0, NULL),
  (2199, 'Rebaixado em 50 cm.', 0, NULL),
  (2200, '1.', 0, NULL),
  (2200, '2.', 0, NULL),
  (2200, '3.', 0, NULL),
  (2200, '4.', 0, NULL),
  ...
  (2204, '10 x 10.', 1, NULL),
  (2204, '11 x 11.', 0, NULL),
  (2205, 'Retângulo escaleno.', 0, NULL),
  (2205, 'Acutângulo escaleno.', 0, NULL),
  (2205, 'Acutângulo isósceles.', 0, NULL),
  (2205, 'Obtusângulo escaleno.', 0, NULL),
  (2205, 'Obtusângulo isósceles.', 1, NULL),
  (2206, '4/21', 0, NULL),
  (2206, '5/21', 0, NULL),
  (2206, '6/21', 0, NULL),
  (2206, '7/21', 1, NULL),
  ...
  (2211, '68.', 0, NULL),
  (2212, '2 X 128', 0, NULL),
  (2212, '64 + 32 + 16 + 8 + 4 + 2', 0, NULL),
  (2212, '128 + 64 + 32 + 16 + 8 + 4 + 2 + 1', 0, NULL),
  (2212, '128 + 64 + 32 + 16 + 8 + 4 + 2', 0, NULL),
  (2212, '64 + 32 + 16 + 8+ 4 + 2+ 1', 1, NULL),
  (2213, '1 ano e 8 meses a 12 anos e 6 meses.', 1, NULL),
  (2213, '1 ano e 8 meses a 5 anos.', 0, NULL),
  (2213, '3 anos e 4 meses a 10 anos.', 0, NULL),
  (2213, '4 anos e 2 meses a 5 anos.', 0, NULL),
  (2213, '4 anos e 2 meses a 12 anos e 6 meses.', 0, NULL),
  (2214, '16º', 0, NULL),
  (2214, '22º', 0, NULL),
  (2214, '23º', 1, NULL),
  (2214, '25º', 0, NULL),
  ...
  (2219, 'X > 1 500.', 0, NULL),
  (2219, 'X < 3 000.', 0, NULL),
  (2219, '1 500 < X < 2 250.', 1, NULL),
  (2219, '1 500 < X < 3 000.', 0, NULL),
  (2219, '2 250 < X < 3 000.', 0, NULL),
  (2220, 'F(t) = 80sen(t) + 88', 1, NULL),
  (2220, 'F(t) = 80cos(t) + 8 8', 0, NULL),
  (2220, 'F(t) = 88cos(t) + 168', 0, NULL),
  (2220, 'F(t) = 168sen(t) + 88cos(t)', 0, NULL),
  (2220, 'F(t) = 88sen(t) + 168cos(t)', 0, NULL),
  (2221, '75° no sentido horário.', 0, NULL),
  (2221, '105° no sentido anti-horário.', 0, NULL),
  (2221, '120° no sentido anti-horário.', 0, NULL),
  (2221, '135° no sentido anti-horário.', 0, NULL),
  (2221, '165° no sentido horário.', 1, NULL),
  (2222, 'Edu.', 0, NULL),
  (2222, 'Dani.', 0, NULL),
  (2222, 'Caio.', 0, NULL),
  (2222, 'Bia.', 0, NULL),
  ...
  (2228, '48', 1, NULL),
  (2228, '79', 0, NULL),
  (2233, 'Qualquer valor acima de 10^{-8}10​−8    	​​.', 0, NULL),
  (2233, 'Qualquer valor positivo inferior a 10^{-7}10​−7​​.', 0, NULL),
  (2233, 'Valores maiores que 7 e menores que 8.', 0, NULL),
  (2233, 'Valores maiores que 70 e menores que 80.', 0, NULL),
  (2233, 'Valores maiores que 10^{-8}10​−8​​ e menores que 10^{-7}10​−7​​.', 1, NULL),
  (2234, '20%', 0, NULL),
  (2234, '25%', 0, NULL),
  (2234, '40%', 0, NULL),
  (2234, '60%', 0, NULL),
  (2234, '80%', 1, NULL),
  (2236, '1,1x10​−1​​', 0, NULL),
  (2236, '1,1x10​−2​​', 0, NULL),
  (2236, '1,1x10​−3​​', 0, NULL),
  (2236, '1,1x10​−4​​', 1, NULL),
  (2236, '1,1x10​−5​​', 0, NULL),
  (2237, 'Será suficiente, pois a área da nova região a ser pavimentada mede 21 m².', 0, NULL),
  (2237, 'Será suficiente, pois a área da nova região a ser pavimentada mede 24 m².', 0, NULL),
  (2237, 'Será suficiente, pois a área da nova região a ser pavimentada mede 48 m².', 0, NULL),
  (2237, 'Não será suficiente, pois a área da nova região a ser pavimentada mede 108 m².', 0, NULL),
  (2237, 'Não será suficiente, pois a área da nova região a ser pavimentada mede 120 m².', 1, NULL),
  (2238, 'I', 0, NULL),
  (2238, 'II', 1, NULL),
  (2238, 'III', 0, NULL),
  (2238, 'IV', 0, NULL),
  (2238, 'V', 0, NULL),
  (2239, 'Segunda-feira.', 1, NULL),
  (2239, 'Terça-feira.', 0, NULL),
  (2239, 'Quarta-feira.', 0, NULL),
  (2239, 'Quinta-feira.', 0, NULL),
  (2239, 'Sexta-feira.', 0, NULL),
  (2240, '2,3.', 0, NULL),
  (2240, '3,5.', 0, NULL),
  (2240, '4,7.', 1, NULL),
  (2240, '5,3.', 0, NULL),
  ...
  (2245, '404,00', 0, NULL),
  (2245, '406,02', 0, NULL),
  (2246, '29,60 e 11,11.', 1, NULL),
  (2246, '28,70 e 13,89.', 0, NULL),
  (2246, '25,00 e 25,00.', 0, NULL),
  (2246, '18,52 e 11,11.', 0, NULL),
  (2246, '12,96 e 13,89.', 0, NULL),
  (2247, 'R$ 3.100,00', 0, NULL),
  (2247, 'R$ 6.000,00', 1, NULL),
  (2247, 'R$ 6.200,00', 0, NULL),
  (2247, 'R$ 15.000,00', 0, NULL),
  (2247, 'R$ 15.500,00', 0, NULL),
  (2248, 'R$ 1.340,00.', 0, NULL),
  (2248, 'R$ 1.349,00', 0, NULL),
  (2248, 'R$ 1.375,00', 0, NULL),
  (2248, 'R$ 1.465,00', 0, NULL),
  (2248, 'R$ 1.474,00.', 1, NULL),
  (2249, 'Pequeno.', 0, NULL),
  (2249, 'Ligeiro.', 0, NULL),
  (2249, 'Moderado.', 1, NULL),
  (2249, 'Grande.', 0, NULL),
  (2249, 'Extremo.', 0, NULL),
  (2250, 'Rolamento.', 0, NULL),
  (2250, 'Catalisador.', 0, NULL),
  (2250, 'Amortecedor.', 0, NULL),
  (2250, 'Pastilha de freio.', 0, NULL),
  (2250, 'Caixa de direção.', 1, NULL),
  (2251, '69', 0, NULL),
  (2251, '70', 0, NULL),
  (2251, '90', 1, NULL),
  (2251, '104', 0, NULL),
  (2251, '105', 0, NULL),
  (2252, '4 hexágonos regulares e 4 triângulos equiláteros.', 1, NULL),
  (2252, '2 hexágonos regulares e 4 triângulos equiláteros.', 0, NULL),
  (2252, '4 quadriláteros e 4 triângulos isósceles.', 0, NULL),
  (2252, '3 quadriláteros e 4 triângulos isósceles.', 0, NULL),
  (2252, '3 hexágonos regulares e 4 triângulos equiláteros.', 0, NULL),
  (2253, '30', 0, NULL),
  (2253, '15', 0, NULL),
  (2253, '12', 1, NULL),
  (2253, '6', 0, NULL),
  ...
  (2257, '12,0000.', 1, NULL),
  (2257, '36,0000.', 0, NULL),
  (2258, 'O primeiro.', 0, NULL),
  (2258, 'O segundo.', 0, NULL),
  (2258, 'O terceiro.', 1, NULL),
  (2258, 'O quarto.', 0, NULL),
  (2258, 'O quinto.', 0, NULL),
  (2259, 'Dez caminhões com capacidade máxima de 10 m³.', 0, NULL),
  (2259, 'Cinco caminhões com capacidade máxima de 10 m³.', 0, NULL),
  (2259, 'Um caminhão com capacidade máxima de 5 m³.', 1, NULL),
  (2259, 'Dez caminhões com capacidade máxima de 2 m³.', 0, NULL),
  (2259, 'Um caminhão com capacidade máxima de 2 m³.', 0, NULL),
  (2261, '2√22 ​cm', 0, NULL),
  (2261, '6√3 ​cm', 0, NULL),
  (2261, '12cm.', 0, NULL),
  (2261, '6√​5​​ cm', 1, NULL),
  (2261, '12√​2 ​cm', 0, NULL),
  (2262, 'Basquete, basquete, basquete, basquete.', 0, NULL),
  (2262, 'Futebol, basquete, basquete, basquete.', 0, NULL),
  (2262, 'Futebol, futebol, basquete, basquete.', 1, NULL),
  (2262, 'Futebol, futebol, futebol, basquete.', 0, NULL),
  (2262, 'Futebol, futebol, futebol, futebol.', 0, NULL),
  (2263, 'Y = 80X + 920.', 0, NULL),
  (2263, 'Y = 80X + 1000.', 0, NULL),
  (2263, 'Y = 80X + 1080.', 0, NULL),
  (2263, 'Y = 160X + 840.', 1, NULL),
  (2263, 'Y = 160X + 1000.', 0, NULL),
  (2264, 'I.', 1, NULL),
  (2264, 'II.', 0, NULL),
  (2264, 'III.', 0, NULL),
  (2264, 'IV.', 0, NULL),
  ...
  (2265, '250', 0, NULL),
  (2265, '500', 0, NULL),
  (2266, 'C412 x C312 x C312 x C212', 0, NULL),
  (2266, 'C412 + C38 + C35 + C22', 0, NULL),
  (2266, 'C412 x 2 x C38 x C25', 0, NULL),
  (2266, 'C412 + 2 + C312 + C312', 0, NULL),
  (2266, 'C412 x C38 x C35 x C22', 1, NULL),
  (2267, 'Janeiro.', 0, NULL),
  (2267, 'Fevereiro.', 0, NULL),
  (2267, 'Março.', 0, NULL),
  (2267, 'Abril.', 1, NULL),
  (2267, 'Maio.', 0, NULL),
  (2268, '0,0500', 0, NULL),
  ...
  (2273, '55.', 0, NULL),
  (2273, '71.', 0, NULL),
  (2274, '1 → 4 → 5 → 4 → 1 → 6 → 1 → 4', 1, NULL),
  (2274, '1 → 2 → 3 → 1 → 4 → 1 → 4 → 4', 0, NULL),
  (2274, '1 → 4 → 5 → 4 → 1 → 6 → 1 → 2 → 3', 0, NULL),
  (2274, '1 → 2 → 3 → 5 → 4 → 1 → 6 → 1 → 4', 0, NULL),
  (2274, '1 → 4 → 2 → 3 → 5 → 1 → 6 → 1 → 4', 0, NULL),
  (2275, 'Austrália.', 1, NULL),
  (2275, 'Canadá.', 0, NULL),
  (2275, 'EUA.', 0, NULL),
  (2275, 'França.', 0, NULL),
  (2275, 'Reino Unido.', 0, NULL),
  (2276, 'Austrália.', 1, NULL),
  (2276, 'Canadá.', 0, NULL),
  (2276, 'EUA.', 0, NULL),
  (2276, 'França.', 0, NULL),
  (2276, 'Reino Unido.', 0, NULL),
  (2277, '27', 0, NULL),
  (2277, '32', 0, NULL),
  (2277, '53', 0, NULL),
  (2277, '63', 1, NULL),
  ...
  (2279, '1 : 100', 1, NULL),
  (2279, '1 : 1 000', 0, NULL),
  (2279, '1 : 10 000', 0, NULL),
  (2279, '1 : 100 000', 0, NULL),
  (2280, '1', 0, NULL),
  (2280, '2', 0, NULL),
  (2280, '3', 1, NULL),
  (2280, '4', 0, NULL),
  (2280, '5', 0, NULL),
  (2281, '5 caixas do tipo A.', 0, NULL),
  (2281, '1 caixa do tipo A e 4 caixas do tipo B.', 0, NULL),
  (2281, '3 caixas do tipo A e 1 caixa do tipo B.', 1, NULL),
  (2281, '5 caixas do tipo A e 1 caixa do tipo B.', 0, NULL),
  (2281, '6 caixas do tipo B.', 0, NULL),
  (2282, '160', 1, NULL),
  (2282, '157', 0, NULL),
  (2282, '130', 0, NULL),
  (2282, '120', 0, NULL),
  ...
  (2285, '20.', 0, NULL),
  (2286, '30 ≤ b', 0, NULL),
  (2286, '30 ≤ b ≤ 31,5', 0, NULL),
  (2286, '30 ≤ b ≤ 33', 1, NULL),
  (2286, '31,5 ≤ b ≤ 33', 0, NULL),
  (2286, 'B ≤ 33', 0, NULL),
  (2288, '114 708.', 0, NULL),
  (2288, '164 076.', 0, NULL),
  (2288, '213 444.', 1, NULL),
  (2288, '284 592.', 0, NULL),
  (2288, '291 582.', 0, NULL),
  (2290, '2 quadrados e 4 retângulos.', 0, NULL),
  (2290, '1 retângulo e 4 triângulos isósceles.', 0, NULL),
  (2290, '2 quadrados e 4 trapézios isósceles.', 1, NULL),
  (2290, '1 quadrado, 3 retângulos e 2 trapézios retângulos.', 0, NULL),
  (2290, '2 retângulos, 2 quadrados e 2 trapézios retângulos.', 0, NULL),
  (2291, 'Às segundas, quintas e sextas-feiras.', 0, NULL),
  (2291, 'Às terças e quintas-feiras e aos sábados.', 0, NULL),
  (2291, 'Às segundas, quartas e sextas-feiras.', 1, NULL),
  (2291, 'Às terças, quartas e sextas-feiras.', 0, NULL),
  (2291, 'Às terças e quartas-feiras e aos sábados.', 0, NULL),
  (2292, '1,0 x 10-1', 0, NULL),
  (2292, '1,0 x 10-3', 0, NULL),
  (2292, '1,0 x 10-4', 1, NULL),
  (2292, '1,0 x 10-6', 0, NULL),
  (2292, '1,0 x 10-7', 0, NULL),
  (2294, 'I', 0, NULL),
  (2294, 'II', 0, NULL),
  (2294, 'III', 0, NULL),
  (2294, 'IV', 1, NULL),
  ...
  (2321, 'IV.', 0, NULL),
  (2321, 'V.', 0, NULL),
  (2322, 'P=d.n + L + d.n.s', 1, NULL),
  (2322, 'P=d.n + L + d.s', 0, NULL),
  (2322, 'P= d+ L +s', 0, NULL),
  (2322, 'P= d.n.s + L', 0, NULL),
  (2322, 'P= d.n + L +s', 0, NULL),
  (2323, '2', 0, NULL),
  (2323, '4', 1, NULL),
  (2323, '6', 0, NULL),
  (2323, '9', 0, NULL),
  ...
  (2327, '10,5.', 0, NULL),
  (2327, '15,0.', 1, NULL),
  (2328, 'A,E,O e S.', 0, NULL),
  (2328, 'D, E, F e G.', 0, NULL),
  (2328, 'D, E, F e G.', 1, NULL),
  (2328, 'D,H,R e V.', 0, NULL),
  (2328, 'X, B L e P.', 0, NULL),
  (2329, '11.', 0, NULL),
  (2329, '15.', 0, NULL),
  (2329, '15,5.', 1, NULL),
  (2329, '15,7.', 0, NULL),
  ...
  (2335, '50,0', 0, NULL),
  (2335, '70,0', 0, NULL),
  (2336, '-3 cos (2t)', 1, NULL),
  (2336, '-3 sen (2t)', 0, NULL),
  (2336, '3 cos (2t)', 0, NULL),
  (2336, '-6 cos (2t)', 0, NULL),
  (2336, '6 cos (2t)', 0, NULL),
  (2337, '1', 0, NULL),
  (2337, '2', 0, NULL),
  (2337, '3', 0, NULL),
  (2337, '4', 0, NULL),
  (2337, '5', 1, NULL),
  (2338, '10% menor', 0, NULL),
  (2338, '1% menor', 1, NULL),
  (2338, 'Igual', 0, NULL),
  (2338, '1% maior', 0, NULL),
  (2338, '11% maior', 0, NULL),
  (2339, '6,0', 1, NULL),
  (2339, '5,7', 0, NULL),
  (2339, '5,0', 0, NULL),
  (2339, '4,5', 0, NULL),
  ...
  (2350, '2196', 0, NULL),
  (2350, '2928', 0, NULL),
  (2351, 'Triângulo', 0, NULL),
  (2351, 'Quadrado', 0, NULL),
  (2351, 'Retângulo', 0, NULL),
  (2351, 'Hexágono', 0, NULL),
  (2351, 'Círculo', 1, NULL),
  (2352, 'Leve no plano, forte no plano, subida moderada e subida forte.', 0, NULL),
  (2352, 'Leve no plano, forte no plano e subida moderada.', 0, NULL),
  (2352, 'Forte no plano, subida moderada e subida forte.', 0, NULL),
  (2352, 'Forte no plano e subida moderada.', 1, NULL),
  (2352, 'Leve no plano e subida forte.', 0, NULL),
  (2353, '6', 0, NULL),
  (2353, '8', 0, NULL),
  (2353, '9', 1, NULL),
  (2353, '15', 0, NULL),
  (2353, '20', 0, NULL),
  (2354, 'X, Y e Z na Farmácia 1.', 0, NULL),
  (2354, 'X e Y na Farmácia 1, e Z na Farmácia 3.', 0, NULL),
  (2354, 'X e Y na Farmácia 2, e Z na Farmácia 3.', 1, NULL),
  (2354, 'X na Farmácia 2, e Y e Z na Farmácia 3.', 0, NULL),
  (2354, 'X, Y e Z na Farmácia 3.', 0, NULL),
  (2355, '12 trapézios isósceles e 12 quadrados.', 1, NULL),
  (2355, '24 trapézios isósceles e 12 quadrados.', 0, NULL),
  (2355, '12 paralelogramos e 12 quadrados.', 0, NULL),
  (2355, '8 trapézios isósceles', 0, NULL),
  (2356, '379', 0, NULL),
  (2356, '381', 0, NULL),
  (2356, '579', 0, NULL),
  (2356, '581', 1, NULL),
  ...
  (2357, '11001', 0, NULL),
  (2358, '700 000', 0, NULL),
  (2358, '1 600 000', 0, NULL),
  (2358, '1 900 000', 1, NULL),
  (2358, '2 200 000', 0, NULL),
  (2358, '2 800 000', 0, NULL),
  (2360, '1,31 mil reais', 0, NULL),
  (2360, '1,90 mil reais', 1, NULL),
  (2360, '2,30 mil reais', 0, NULL),
  (2360, '2,36 mil reais', 0, NULL),
  (2360, '2,95 mil reais', 0, NULL),
  (2361, '1,31 mil reais', 0, NULL),
  (2361, '1,90 mil reais', 1, NULL),
  (2361, '2,30 mil reais', 0, NULL),
  (2361, '2,36 mil reais', 0, NULL),
  (2361, '2,95 mil reais', 0, NULL),
  (2362, '1', 0, NULL),
  (2362, '2', 0, NULL),
  (2362, '3', 0, NULL),
  (2362, '4', 0, NULL),
  ...
  (2364, '3,0', 1, NULL),
  (2364, '5,5', 0, NULL),
  (2365, '1,80 e 0,60.', 1, NULL),
  (2365, '1,80 e 0,70.', 0, NULL),
  (2365, '1,90 e 0,80.', 0, NULL),
  (2365, '2,00 e 0,90.', 0, NULL),
  (2365, '2,00 e 1,00.', 0, NULL),
  (2366, '22.', 0, NULL),
  (2366, '25.', 1, NULL),
  (2366, '28.', 0, NULL),
  (2366, '48.', 0, NULL),
  ...
  (2371, '15.', 0, NULL),
  (2371, '16', 1, NULL),
  (2372, 'Não satisfatório.', 0, NULL),
  (2372, 'Regular.', 0, NULL),
  (2372, 'Bom.', 1, NULL),
  (2372, 'Muito bom.', 0, NULL),
  (2372, 'Excelente.', 0, NULL),
  (2374, '1,0.', 0, NULL),
  (2374, '1,5.', 1, NULL),
  (2374, '1,9.', 0, NULL),
  (2374, '2,1.', 0, NULL),
  (2374, '2,5.', 0, NULL),
  (2375, 'Apenas no ginásio I.', 0, NULL),
  (2375, 'Apenas nos ginásios I e II.', 0, NULL),
  (2375, 'Apenas nos ginásios I, II e III.', 0, NULL),
  (2375, 'Apenas nos ginásios I, II, III e IV.', 1, NULL),
  (2375, 'Em todos os ginásios.', 0, NULL),
  (2376, '30 minutos ou menos.', 0, NULL),
  (2376, 'Mais de 35 e menos de 45 minutos.', 0, NULL),
  (2376, 'Mais de 45 e menos de 55 minutos.', 1, NULL),
  (2376, 'Mais de 60 e menos de 70 minutos.', 0, NULL),
  (2376, '70 minutos ou mais.', 0, NULL),
  (2377, '26', 0, NULL),
  (2377, '27', 0, NULL),
  (2377, '28', 1, NULL),
  (2377, '29', 0, NULL),
  ...
  (2390, '10,0', 0, NULL),
  (2390, '730,0', 0, NULL),
  (2390, '13 322,5', 0, NULL),
  (2390, '53 290,0', 0, NULL),
  (2391, '1', 1, NULL),
  (2391, '2', 0, NULL),
  (2391, '3', 0, NULL),
  (2391, '4', 0, NULL),
  (2392, 'R$ 2,00 menor.', 1, NULL),
  (2392, 'R$ 100,00 menor.', 0, NULL),
  (2392, 'R$ 200,00 menor.', 0, NULL),
  (2392, 'R$ 42,00 maior.', 0, NULL),
  (2392, 'R$ 80,00 maior.', 0, NULL),
  (2393, 'DDEFDDEEFFD.', 0, NULL),
  (2393, 'DFEFDDDEFFD.', 0, NULL),
  (2393, 'DFEFDDEEFFD.', 1, NULL),
  (2393, 'EFDFEEDDFFE.', 0, NULL),
  (2393, 'EFDFEEEDFFE.', 0, NULL),
  (2394, 'I.', 0, NULL),
  (2394, 'II.', 0, NULL),
  (2394, 'III.', 0, NULL),
  (2394, 'IV.', 0, NULL),
  ...
  (2399, '4800', 1, NULL),
  (2399, '6400', 0, NULL),
  (2400, '135 000,00.', 0, NULL),
  (2400, '1 350 000,00.', 0, NULL),
  (2400, '13 500 000,00.', 0, NULL),
  (2400, '135 000 000,00.', 0, NULL),
  (2400, '1 350 000 000,00', 1, NULL),
  (2401, 'I', 0, NULL),
  (2401, 'II', 0, NULL),
  (2401, 'III', 0, NULL),
  (2401, 'IV', 1, NULL),
  ...
  (2404, '75,23.', 0, NULL),
  (2404, '78,49.', 0, NULL),
  (2407, 'Forem ambas audíveis.', 0, NULL),
  (2407, 'Tiverem a mesma potência.', 0, NULL),
  (2407, 'Tiverem a mesma frequência.', 1, NULL),
  (2407, 'Tiverem a mesma intensidade.', 0, NULL),
  (2407, 'Propagarem-se com velocidades diferentes.', 0, NULL),
  (2408, 'Saliva, por consequência da atividade de enzimas.', 0, NULL),
  (2408, 'Sangue, em função das hemácias e leucócitos.', 0, NULL),
  (2408, 'Lágrima, em razão da concentração de sais.', 0, NULL),
  (2408, 'Urina, pela presenca de moléculas de ureia.', 0, NULL),
  (2408, 'Leite, por causa do alto teor de gorduras.', 1, NULL),
  (2409, 'Ter a durabilidade de uma cerâmica e ser totalmente biodegradável.', 0, NULL),
  (2409, 'Ser tão durável quanto uma cerâmica e ter alta condutividade térmica.', 0, NULL),
  (2409, 'Ser um mau condutor térmico e aumentar o resíduo biodegradável na natureza.', 0, NULL),
  (2409, 'Ter baixa condutividade térmica e reduzir o resíduo não biodegradável na natureza.', 1, NULL),
  (2409, 'Ter alta condutividade térmica e possibilitar a degradação do material no meio ambiente.', 0, NULL),
  (2410, 'Maior densidade.', 1, NULL),
  (2410, 'Menor viscosidade.', 0, NULL),
  (2410, 'Maior volume de gás dissolvido.', 0, NULL),
  (2410, 'Menor massa de solutos dissolvidos.', 0, NULL),
  (2410, 'Maior temperatura de congelamento.', 0, NULL),
  (2411, '1.198,8', 0, NULL),
  (2411, '1.296,0', 1, NULL),
  (2411, '1.360,8', 0, NULL),
  (2411, '4.665,6', 0, NULL),
  (2411, '4.860,0', 0, NULL),
  (2412, '2.000,00.', 0, NULL),
  (2412, '2.500,00.', 0, NULL),
  (2412, '3.250,00.', 1, NULL),
  (2412, '4.500,00.', 0, NULL),
  (2412, '9.000,00.', 0, NULL),
  (2413, '20', 0, NULL),
  (2413, '60', 0, NULL),
  (2413, '64', 1, NULL),
  (2413, '68', 0, NULL),
  ...
  (2414, 'Julho.', 0, NULL),
  (2414, 'Agosto.', 0, NULL),
  (2414, 'Setembro.', 1, NULL),
  (2414, 'Outubro.', 0, NULL),
  (2415, 'Mediana = média < moda.', 0, NULL),
  (2415, 'Mediana = moda < média.', 0, NULL),
  (2415, 'Mediana < média < moda.', 0, NULL),
  (2415, 'Moda < média < mediana.', 0, NULL),
  (2415, 'Moda < mediana < média.', 1, NULL),
  (2417, '50', 1, NULL),
  (2417, '60', 0, NULL),
  (2417, '80', 0, NULL),
  (2417, '140', 0, NULL),
  ...
  (2419, '1,8', 0, NULL),
  (2419, '2,7', 0, NULL),
  (2421, 'Há somente uma solução possível, e as somas em cada lado do triângulo são iguais a 7.', 0, NULL),
  (2421, 'Há somente uma solução possível, e as somas em cada lado do triângulo são iguais a 9.', 0, NULL),
  (2421, 'Há somente duas soluções possíveis, uma em que as somas em cada lado do triângulo são iguais a 7 e outra em que as somas são iguais a 9.', 0, NULL),
  (2421, 'Há somente duas soluções possíveis, uma em que as somas em cada lado do triângulo são iguais a 9 e outra em que as somas são iguais a 12.', 0, NULL),
  (2421, 'Há somente duas soluções possíveis, uma em que as somas em cada lado do triângulo são iguais a 10 e outra em que as somas são iguais a 11.', 1, NULL),
  (2422, '1', 0, NULL),
  (2422, '4', 0, NULL),
  (2422, '6', 0, NULL),
  (2422, '7', 1, NULL),
  ...
  (2423, 'C = 0,9q', 1, NULL),
  (2423, 'C = 0,1q', 0, NULL),
  (2423, 'C = 1 − 0,1q', 0, NULL),
  (2423, 'C = 1 − 0,9q', 0, NULL),
  (2423, 'C = q − 10', 0, NULL),
  (2424, '3', 0, NULL),
  (2424, '4', 1, NULL),
  (2424, '6', 0, NULL),
  ...
  (2430, '12', 1, NULL),
  (2430, '18', 0, NULL),
  (2431, 'Tipo I, pois p1 < p2 < p3.', 1, NULL),
  (2431, 'Tipo I, pois tem menor quantidade de caracteres.', 0, NULL),
  (2431, 'Tipo II, pois tem maior quantidade de letras.', 0, NULL),
  (2431, 'Tipo III, pois p3 < p2 < p1', 0, NULL),
  (2431, 'Tipo III, pois tem maior quantidade de caracteres.', 0, NULL),
  (2432, '6,7%', 0, NULL),
  (2432, '10%', 0, NULL),
  (2432, '20%', 0, NULL),
  (2432, '21,5%', 1, NULL),
  ...
  (2433, 'Y = 500x', 0, NULL),
  (2433, 'Y = 750x', 0, NULL),
  (2433, 'Y = 250x + 500', 1, NULL),
  (2433, 'Y = 500x + 250', 0, NULL),
  (2435, 'Indígenas.', 0, NULL),
  (2435, 'Gestantes.', 0, NULL),
  (2435, 'Doentes crônicos.', 0, NULL),
  (2435, 'Adultos entre 20 e 29 anos.', 1, NULL),
  (2435, 'Crianças de 6 meses a 2 anos.', 0, NULL),
  (2436, '1,20.', 0, NULL),
  (2436, '1,35.', 0, NULL),
  (2436, '1,65.', 0, NULL),
  (2436, '1,80.', 0, NULL),
  (2436, '1,95.', 1, NULL),
  (2437, 'Segunda-feira.', 0, NULL),
  (2437, 'Terça-feira.', 0, NULL),
  (2437, 'Quarta-feira.', 1, NULL),
  (2437, 'Quinta-feira.', 0, NULL),
  (2437, 'Sexta-feira.', 0, NULL),
  (2438, '(5,0 ; 5,5).', 1, NULL),
  (2438, '(8,0 ; 8,5).', 0, NULL),
  (2438, '(11,5 ; 12,5).', 0, NULL),
  (2438, '(19,5 ; 20,5).', 0, NULL),
  (2438, '(3,5 ; 4,0).', 0, NULL),
  (2441, 'Ótimo.', 0, NULL),
  (2441, 'Bom.', 0, NULL),
  (2441, 'Normal.', 0, NULL),
  ...
  (2443, '0° < a < 90°', 0, NULL),
  (2443, 'A = 90°', 0, NULL),
  (2443, '90° < a < 180°', 1, NULL),
  (2443, 'A = 180°', 0, NULL),
  (2443, '180° < a < 360°', 0, NULL),
  (2445, '4,68', 0, NULL),
  (2445, '6,30', 1, NULL),
  (2445, '9,30', 0, NULL),
  (2445, '10,50', 0, NULL),
  ...
  (2446, '89', 0, NULL),
  (2446, '92', 1, NULL),
  (2449, 'Okosa urapum urapum urapum e okosa okosa urapum urapum urapum.', 0, NULL),
  (2449, 'Okosa okosa urapum e okosa okosa okosa okosa urapum.', 0, NULL),
  (2449, 'Okosa okosa urapum e okosa okosa okosa urapum.', 1, NULL),
  (2449, 'Okosa urapum urapum e okosa urapum okosa urapum urapum.', 0, NULL),
  (2449, 'Okosa okosa urapum e okosa okosa okosa okosa.', 0, NULL),
  (2450, 'Outubro.', 0, NULL),
  (2450, 'Novembro.', 0, NULL),
  (2450, 'Dezembro.', 1, NULL),
  (2450, 'Janeiro.', 0, NULL),
  (2450, 'Fevereiro.', 0, NULL),
  (2451, 'Outubro.', 0, NULL),
  (2451, 'Novembro.', 0, NULL),
  (2451, 'Dezembro.', 1, NULL),
  (2451, 'Janeiro.', 0, NULL),
  (2451, 'Fevereiro.', 0, NULL);
